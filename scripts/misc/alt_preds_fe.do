...
// autocorrelation 
xtgls inc_labor male m_ed0y piatmath years_30y si21y_inc_labor linc_labor, corr(psar1) force igls
matrix b1 = e(b)
...
// autocorrelaion 
xtgls inc_labor male years_30y si30y_inc_labor linc_labor, corr(psar1) force igls
matrix b2 = [e(b)]
...
cd $output
outtable using auto_npvmat_fe, mat(mat) replace nobox center f(%9.3f)
