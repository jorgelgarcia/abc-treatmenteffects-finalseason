...
/*
Project :       ABC CVA
Description:    Test of endogeneity of prediction function, transfer income, ABC and CARE samples control only
...
foreach b of numlist 1(1)$bootstraps {
	...
	reg si30y_inc_trans_pub m_ed0y cogfactor noncogfactor if R == 0, robust
	matrix t1f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub cogfactor noncogfactor if R == 0, robust
	matrix t2f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub si34y_bmi cogfactor noncogfactor if R == 0, robust
	matrix t3f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y if R == 0, robust
	matrix t1 = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub if R == 0, robust
	matrix t2 = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub si34y_bmi if R == 0, robust
	matrix t3 = e(b)
...
cd $output
outtable using abccare_endogcontrol_ti, mat(allcoeffs) replace nobox center f(%9.3f)
