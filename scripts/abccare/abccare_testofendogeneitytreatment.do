...
/*
Project :       ABC CVA
Description:    Test of endogeneity of prediction function, labor income, ABC and CARE samples treatment only
...
foreach b of numlist 1(1)$bootstraps {
	...
	reg si30y_inc_labor m_ed0y cogfactor noncogfactor if R == 1, robust
	matrix t1f = e(b)
	...
	reg si30y_inc_labor m_ed0y piatmath years_30y si21y_inc_labor cogfactor noncogfactor if R == 1, robust
	matrix t2f = e(b)
	...
	reg si30y_inc_labor m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi cogfactor noncogfactor if R == 1, robust
	matrix t3f = e(b)
	...
	reg si30y_inc_labor m_ed0y if R == 1, robust
	matrix t1 = e(b)
	...
	reg si30y_inc_labor m_ed0y piatmath years_30y si21y_inc_labor if R == 1, robust
	matrix t2 = e(b)
	...
	reg si30y_inc_labor m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi if R == 1, robust
	matrix t3 = e(b)
...
cd $output
outtable using abccare_endog_treatment, mat(allcoeffs) replace nobox center f(%9.3f)
