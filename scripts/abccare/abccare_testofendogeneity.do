...
matrix rownames allests`varyy' = R m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi cogfactor noncogfactor cons F R2 N
	foreach b of numlist 1(1)$bootstraps {
		...
		reg `varyy' R m_ed0y cogfactor noncogfactor, robust
		matrix t1f = e(b)
		...
		reg `varyy' R m_ed0y piatmath years_30y si21y_inc_labor cogfactor noncogfactor, robust
		matrix t2f = e(b)
		...
		reg `varyy' R m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi cogfactor noncogfactor, robust
		matrix t3f = e(b)
		...
		reg `varyy' R m_ed0y piatmath years_30y si21y_inc_labor, robust
		matrix t2 = e(b)
		...
		reg `varyy' R m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi, robust
		matrix t3 = e(b)
	...
	cd $output
	outtable using abccare_endog_`varyy', mat(all`varyy') replace nobox center f(%9.3f)
	restore 
}
