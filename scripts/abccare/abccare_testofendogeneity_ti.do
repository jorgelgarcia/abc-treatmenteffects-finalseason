...
/*
Project :       ABC CVA
Description:    Test of endogeneity of prediction function, transfer income, ABC and CARE samples
...
foreach b of numlist 1(1)$bootstraps {
	...
	reg si30y_inc_trans_pub m_ed0y cogfactor noncogfactor, robust
	matrix t1f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub cogfactor noncogfactor, robust
	matrix t2f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub si34y_bmi cogfactor noncogfactor, robust
	matrix t3f = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y, robust
	matrix t1 = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub, robust
	matrix t2 = e(b)
	...
	reg si30y_inc_trans_pub m_ed0y piatmath years_30y si21y_inc_trans_pub si34y_bmi, robust
	matrix t3 = e(b)
...
cd $output
outtable using abccare_endog_ti, mat(allcoeffs) replace nobox center f(%9.3f)
