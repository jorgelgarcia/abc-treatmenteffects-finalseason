...
paths.abc = os.path.join(os.environ['klmshare'], 'Data_Central', 'Abecedarian', 'data', 'ABC-CARE', 'extensions', 'cba-iv', 'abccare-parent.dta')
paths.nlsy = os.path.join(os.environ['klmshare'], 'Data_Central', 'data-repos', 'nlsy', 'extensions', 'abc-match-nlsy', 'nlsy-abc-match.dta')
paths.cnlsy = os.path.join(os.environ['klmshare'], 'Data_Central', 'data-repos', 'nlsy', 'extensions', 'abc-match-cnlsy', 'cnlsy-abc-match-parent.dta')
