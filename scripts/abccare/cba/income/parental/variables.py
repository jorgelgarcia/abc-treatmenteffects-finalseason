...
cols.interpABC.background = ['male', 'm_ed0y', 'black', 'male_subject', 'inc_labor_mean', 'inc_labor_last', 'last_age']
...
cols.extrap.predictors = ['inc_labor_mean']
cols.extrap.keep = cols.extrap.predictors + cols.extrap.outcomes + cols.extrap.background + ['male_subject']
