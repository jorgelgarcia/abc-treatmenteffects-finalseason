...
foreach b of numlist 1(1)$bootstraps {
	...
	// construct ipw
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi
	...
	reg p_inc21 m_ed0y cogfactor noncogfactor [aw=ipw] if R == 1, robust
	matrix t1f = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor cogfactor noncogfactor [aw=ipw] if R == 1, robust
	matrix t2f = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi cogfactor noncogfactor [aw=ipw] if R == 1, robust
	matrix t3f = e(b)
	...
	reg p_inc21 m_ed0y [aw=ipw] if R == 1, robust
	matrix t1 = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor [aw=ipw] if R == 1, robust
	matrix t2 = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi [aw=ipw] if R == 1, robust
	matrix t3 = e(b)
	...
	reg p_inc21 m_ed0y cogfactor noncogfactor [aw=ipw] if R == 0, robust
	matrix c1f = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor cogfactor noncogfactor [aw=ipw] if R == 0, robust
	matrix c2f = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi cogfactor noncogfactor [aw=ipw] if R == 0, robust
	matrix c3f = e(b)
	...
	reg p_inc21 m_ed0y [aw=ipw] if R == 0, robust
	matrix c1 = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor [aw=ipw] if R == 0, robust
	matrix c2 = e(b)
	...
	reg p_inc21 m_ed0y piatmath years_30y si21y_inc_labor si34y_bmi [aw=ipw] if R == 0, robust
	matrix c3 = e(b)
...
foreach num of numlist 1(1)3 {
	outtable using abccare_funcform`num'_pi, mat(allcoefsc`num') replace nobox center f(%9.3f)
}
