...
file open tabfile using "${output}/perry-proportion-summary-full.tex", replace write
...
file write tabfile "% This file generated by: abccare-cba/scripts/abccare/genderdifferences/perry-gdiff-gaps-ranksign.do" _n
file close tabfile
