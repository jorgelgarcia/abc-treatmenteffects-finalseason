...
for sex in ['pooled', 'male', 'female']:
    itt_all = pd.read_csv(os.path.join(path_results, 'itt', 'itt_{}_P10_sib1.csv'.format(sex)), index_col=['rowname', 'draw', 'ddraw'])
    itt_p1 = pd.read_csv(os.path.join(path_results, 'itt', 'itt_{}_P1_sib1.csv'.format(sex)), index_col=['rowname', 'draw', 'ddraw'])    
    itt_p0 = pd.read_csv(os.path.join(path_results, 'itt', 'itt_{}_P0_sib1.csv'.format(sex)), index_col=['rowname', 'draw', 'ddraw'])
    
    matching_p1 = pd.read_csv(os.path.join(path_results, 'matching', 'matching_{}_P1_sib1.csv'.format(sex)), index_col=['rowname', 'draw', 'ddraw'])    
    matching_p0 = pd.read_csv(os.path.join(path_results, 'matching', 'matching_{}_P0_sib1.csv'.format(sex)), index_col=['rowname', 'draw', 'ddraw'])
