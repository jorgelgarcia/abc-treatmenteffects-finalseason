...
/*
Project :       ABC CBA
Description:    plot combining functions for positive treatment effects, ABC and CARE samples (home scores only)
...
foreach sex in male female {
	...
	insheet using rslt_`sex'_counts_n50a100.csv, clear
...
foreach var in itt_noctrl epan_ipw_p0 epan_ipw_p1 {
	...
	# delimit cr
	graph export `var'_home.eps, replace
}
