...
% -------------------------------------------------------------------------------------------------
\documentclass[print]{JJH-Beamer}
...
\def \thetitle {The Long-term Economic and Social Benefits of an Influential Early Childhood Intervention} % Full title goes here

\def \theshorttitle {Benefits of Early Childhood Intervention} %Short title goes here
...
\frametitle{Preview of Results: Cost-benefit Analysis}
	...
	\end{itemize}
	\begin{center}
	\scalebox{.75}{\input{output/cba_summary_controls_trim}}
	\end{center}	
\end{frame}
...
\begin{frame}[plain]
\begin{figure}
\caption{Life-cycle Net Present Value of Main Component of the CBA, Males and Females}
	\includegraphics[width=20em]{output/abccare_npvs3.eps}
\end{figure}
\end{frame}

\begin{frame}[plain]
\begin{figure}
\caption{Life-cycle Net Present Value of Main Component of the CBA, Males}
	\includegraphics[width=20em]{output/abccare_npvs2.eps}
\end{figure}
\end{frame}

\begin{frame}[plain]
\begin{figure}
\caption{Life-cycle Net Present Value of Main Component of the CBA, Females}
	\includegraphics[width=20em]{output/abccare_npvs1.eps}
\end{figure}
\end{frame}
...
\begin{table}
	...
	\scalebox{.45}{\input{output/sensitivityforslides.tex}}
\end{table}
\end{center}
\end{frame}
\clearpage
