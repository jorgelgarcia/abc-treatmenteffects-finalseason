...
\noindent We acknowledge and propose a methodology to account for cases of non-compliance to treatment for which ABC has been criticized \citep{Hu_2014_ABC-Study}. In fact, we present a thorough documentation for each of the cases of non-compliance at each stage of the data collection for both programs.\\ 
