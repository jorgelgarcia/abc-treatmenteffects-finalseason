...
\noindent We also present the counts of positive effects, with a comparable inference exercise, in Table~\ref{tab:counts_male}. We fail to reject that at most 50\% of the outcomes are socially beneficial for any of the estimates we consider. The effects are weaker than for the case of females.\\
