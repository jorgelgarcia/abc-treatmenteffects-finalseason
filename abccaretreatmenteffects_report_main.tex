...
\begin{eqnarray}
\text{ATE} \left( \text{fix } P = 0 \right) &:=& \mathbb{E} \left[ Y_{0} \left( \text{fix } P = 0 \right) \right] -  \mathbb{E} \left[ Y_{1} \left( \text{fix } P = 0 \right) \right] \\
\text{ATE} \left( \text{fix } P = 1 \right) &:=& \mathbb{E} \left[ Y_{0} \left( \text{fix } P = 1 \right) \right] -  \mathbb{E} \left[ Y_{1} \left( \text{fix } P = 1 \right) \right],
\end{eqnarray}
