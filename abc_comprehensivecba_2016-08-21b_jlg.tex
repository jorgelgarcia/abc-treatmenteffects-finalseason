...
\textbf{[JJH: Jorge, please make a coherent figure for the program overall. What are control substitutions and benefits? Where is reduced special education? At base of table please place definition of each item. What is ``control substitution''? Please be clear. Edit down --- figure too busy. Just present the overall numbers (stay at home and alt preschool)] [Typist: Jorge is working on this figure.] [JLG: figure inserted.]}
