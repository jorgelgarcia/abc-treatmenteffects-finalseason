...
\externaldocument{abc_comprehensivecba_appendix_2017-05-25a_sjs}
...
\centering
\includegraphics[width=.7\columnwidth]{abccare_npvssummredux.eps}
\floatfoot{
\scriptsize
...
\centering
\includegraphics[width=.7\columnwidth]{venn_pooled.pdf}
\floatfoot{
\footnotesize
...
\begin{subfigure}[h]{0.49\textwidth}
	...
	\includegraphics[width=\textwidth]{overalldist_BCRatio}
\end{subfigure}
\begin{subfigure}[h]{0.49\textwidth}
	\centering
	\caption{Internal Rate of Return} \label{fig:irr}
	\includegraphics[width=\textwidth]{overalldist_IRR}
\end{subfigure}%
...
\begin{subfigure}[h]{0.5\textwidth}
		...
		\includegraphics[width=\textwidth]{labor_25-65_pset1_mset1_male.eps}
\end{subfigure}%
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Females} \label{fig:labor-income-profilesa}
		\includegraphics[width=\textwidth]{labor_25-65_pset1_mset1_female.eps}
\end{subfigure}
\footnotesize \justify
...
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Males}
		\includegraphics[width=\textwidth]{abccare_disad_1.eps}
\end{subfigure}%
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Females}
		\includegraphics[width=\textwidth]{abccare_disad_0.eps}
\end{subfigure}
\footnotesize \justify
...
\centering
\footnotesize
\input{alternative_specifications}
\begin{tablenotes}
\normalsize
...
\centering
\includegraphics[width=.7\columnwidth]{qalyexppsid.eps}
\floatfoot{
\footnotesize
...
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Males}
		\includegraphics[width=\textwidth]{abccare_npvs2.eps}
\end{subfigure}%
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Females}
		\includegraphics[width=\textwidth]{abccare_npvs1.eps}
\end{subfigure}
\scriptsize \justify
...
\centering
\footnotesize
\input{back-envelope-comparison-table.tex}
\begin{tablenotes}
\footnotesize
