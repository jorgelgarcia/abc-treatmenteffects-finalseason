...
\externaldocument{abc_comprehensivecba_appendix_2016-07-31a_jlg.tex}
\pagenumbering{roman}
...
\title{\Large \textbf{The Long-term Economic and Social Benefits of an Influential Early Childhood Intervention}\thanks{This research was supported in part by the American Bar Foundation; the Pritzker Children's Initiative, the
...
\begin{abstract}
This paper analyzes the economic and social benefits of an influential early childhood intervention that was targeted to a disadvantaged, predominately African-American population. The program serves as a prototype for many current and proposed interventions. We evaluate its multiple benefits over a variety of domains: (a) health and quality of life, (b) earnings, (c) crime, and (d) childcare benefits to mothers. We evaluate benefits by domain. We aggregate benefits and costs to produce overall benefit/cost ratios and rates of return that count the welfare costs of taxation to finance the programs. There are pronounced effects by gender. The overall rate of return is a statistically significant 13\% per annum with a benefit/cost ratio of 5.7, even after accounting for the welfare costs of taxation to finance the intervention. Our estimates are robust to a variety of sensitivity and specification checks.
\end{abstract}

\noindent \textbf{Keywords}: Health, childcare, crime, randomized trials \\
...
\item ABC/CARE
    ...
    \item Prototype for many successor programs
        \begin{enumerate}[(i)]
        \item IHDP
        \item Early Head Start
        \item Sparling's list (Australia)
        \end{enumerate}
    \item Many children eligible for it in U.S. (22\% of all children)
...
\item Costs 
    ...
    \end{enumerate}
\item Evaluation of teachers through age 34
    \begin{enumerate}[(a)]
    \item Account for substitution bias
    \item Vectors of outcomes 
    \item Deal with multiplicity 
        \begin{enumerate}[(i)]
        \item Step-down 
        \item Counts 
        \item CBA
...
\item Main findings: differ by gender 
    \begin{enumerate}[(a)]
    \item Substantial benefits for health and QALY (primarily for men)
...
There is growing interest in the benefits of early childhood interventions for promoting social mobility among disadvantaged populations.\footnote{\cite{UNICEF_2016_Website,White_House_2014_Econ_of_EC_Investments}.} Yet the long-term evidence on their effectiveness is limited. The major source of evidence is from the Perry Preschool Program.\footnote{\cite{Schweinhart_Montie_ea_2005_BOOKlifetime}, \cite{Conti_Heckman_2010_PPS} and \cite{Heckman_Moon_etal_2010_RateofReturn}.}

More recent studies of early childhood interventions focus on a limited set of outcomes like IQ or scores on school readiness measures.\footnote{See, e.g., \cite{Kline_Walters_2014_EvaluatingPublicPrograms} and \cite{Weiland_2013_CD_Impacts-of-Pre-K}.} They have short-term followup and often do not adjust for attrition or noncompliance with experimental protocols.\footnote{See, e.g., \cite{Lipsey_et_al_2015_Randomized_Control_Trial_PRI}.}

This paper contributes to this literature by considering the long-term benefits of two closely related randomized trial early childhood interventions launched in the early 1970s\footnote{} with long-term followups on which we have the data through age 34. We analyze a variety of life relevant outcomes such as health, the quality of life, participation in crime, earnings, childcare costs of mothers, and schooling. The intensive program starts early (at 8 weeks) and engages treatment group participants to age 5. It is the prototype for a variety of subsequent programs.\footnote{The names of the programs with years launched in parentheses are the following. IHDP---eight different cites nation-wide \citep{Spiker-etal_1997_Helping}; Early Head Start and Head Start \citep{Schneider_McDonald-eds_2007_Scale-Up_Vol-1}; John's Hopkins Cerebral Plasty Study \citep{Sparling_2010_Highlights}; CLIO study \citep{Sparling_2010_Highlights}; Massachusetts Family Child Care Study \citep{Collins_etal_2010_Massachusetts-Study}; Healthy Child Manitoba Evaluation \citep{Healthy_Child_Manitoba_2015_Starting-Early}; and Abecedarian Approach within an Innovative Implementation Framework \citep{Jensen_Nielsen_2016_ABC-Programme-Pilot}.} The Educare programs are based on ABC/CARE.\footnote{\textbf{[JJH: Cite the Educare programs and please cite the materials in Buffett]}}

The program has recently been shown to have substantial benefits on health at age 34. Benefits on selected outcomes such as crime and education through age 30 have been published.\footnote{\cite{Campbell_Conti_etal_2014_EarlyChildhoodInvestments,Burchinal_2015_ABC-Mediation_Personal-Comm,Burchinal_etal_2015_ECE-Book_Handbook-Child-Psy} \textbf{[Typist: Is this enough for Burchinal?]}.}

This paper presents a unified analysis of the diverse array of benefits from ABC/CARE. We use multiple methodologies to analyze blocks of outcomes by category (health care; childcare; earnings; education) and aggregate over all of the blocks by presenting a benefit/cost analysis that accounts for all of the measured benefits and the costs of funds to publicly finance the program.\footnote{We adjust estimates to account for substitution bias in the control groups, which arises when control group members find substitutes for the treatment denied them by randomizations.}

To conduct a rigorous benefit/cost analysis we combine data from multiple panel data sources to project benefits and costs over a lifetime. We account for sampling uncertainty in pooling data and projecting benefits and conduct sensitivity analysis for components where sampling uncertainty is not readily quantified.

\cite{Barnett_Masse_2002_benefitcost,Barnett_Masse_2007_EER} present a cost/benefit analysis for the program for outcomes through age 21. They do not account for health, benefits, use self-reported crime data (unlike the police record data we analyze) and ignore the social welfare costs of financing the program. We use cost data from a variety of sources not used by them. 

We report substantial benefits of ABC/CARE for health and the quality of life. These are more pronounced for men than women. There are substantial childcare benefits that promote work by treatment mothers. There are substantial benefits in terms of crime reduction (for men), earnings gains (for both male and female participants) and education. 

The rate of return is a statistically significant 13\% with an associated benefit/cost ratio of 5.7. This evidence is relevant for today's policy discussion because the main ingredients of ABC/CARE are found in many newly launched programs and because currently 23\% of all American children would be eligible for participation in ABC/CARE.\

Plan of the paper

\begin{enumerate}[(1)]
\item Review program and methodological challenges 
\item Review the methodology 
\item Estimates by block (counts/step down)
\item CBA
\item Summary 
\end{enumerate} 
