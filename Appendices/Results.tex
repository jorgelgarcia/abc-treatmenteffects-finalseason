...
\noindent We follow the samr procedure to elect the ``matching'' variables for the estimates of ``treatment vs. stay at home'' and ``treatment vs. alternative preschools parameters'' (see Section~\ref{section:methodsquestions}. We analyze sensitivity to the choice of these controls next.
