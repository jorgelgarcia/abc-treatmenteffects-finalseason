...
\noindent Table \ref{tab:main-outcomes} lists the 95 main outcomes that we test in our main analysis. We present treatment effects on both main outcomes and supplementary outcomes. We reverse the outcomes for which we consider a negative treatment effect socially positive.
