...
\begin{sidewaystable}[H]
\begin{threeparttable}
\caption{Prediction of Parental Income at (Child's) Age 21 Accounting for $R, \bm{B}, \bm{\theta},$ and $\bm{X}_{t}$, ABC/CARE}
\label{table:end1}
\centering
\scriptsize
...
\begin{sidewaystable}[H]
\begin{threeparttable}
\caption{Prediction of Labor Income at Age 30 Accounting for $R, \bm{B}, \bm{\theta},$ and $\bm{X}_{t}$, ABC/CARE}
\label{table:end2}
\centering
\scriptsize
...
\begin{sidewaystable}[H]
\begin{threeparttable}
\caption{Prediction of Transfer Income at Age 30 Accounting for $R, \bm{B}, \bm{\theta},$ and $\bm{X}_{t}$, ABC/CARE}
\label{table:end3}
\centering
\scriptsize
