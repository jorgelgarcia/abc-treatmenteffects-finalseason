...
\begin{table}[H] 
\begin{threeparttable}
\caption{Parental Labor Income, }
\label{table:psens}
\centering 
\input{output/yourtable.tex}
\begin{tablenotes}
\footnotesize
\item Note: 
\end{tablenotes}
