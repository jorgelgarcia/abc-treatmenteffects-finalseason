...
\input{output/abccare-outcome-var-iq}
\begin{tablenotes}
\footnotesize
...
\begin{threeparttable}
\input{output/abccare-outcome-var-ach}
\begin{tablenotes}
\footnotesize
...
\begin{adjustbox}{width=0.8\textwidth}
\begin{threeparttable}
\input{output/abccare-outcome-var-home}
\begin{tablenotes}
\footnotesize
...
\begin{threeparttable}
\input{output/abccare-outcome-var-se}
\begin{tablenotes}
\footnotesize
...
\begin{adjustbox}{width=0.8\textwidth}
\begin{threeparttable}
\input{output/abccare-outcome-var-ed}
\begin{tablenotes}
\footnotesize
...
\begin{threeparttable}
\input{output/abccare-outcome-var-emp}
\begin{tablenotes}
\footnotesize
...
\begin{adjustbox}{width=0.9\textwidth}
\begin{threeparttable}
\input{output/abccare-outcome-var-parent}
\begin{tablenotes}
\footnotesize
...
\begin{adjustbox}{width=0.9\textwidth}
\begin{threeparttable}
\input{output/abccare-outcome-var-health}
\begin{tablenotes}
\footnotesize
...
\begin{adjustbox}{width=0.9\textwidth}
\begin{threeparttable}
\input{output/abccare-outcome-var-crime}
\begin{tablenotes}
\footnotesize
