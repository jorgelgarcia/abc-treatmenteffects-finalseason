...
\noindent Below we explore how the internal rate of return and benefit-cost ratio change as
...
is stable across different levels of public-transfer income, QALYs, health costs, criminal 
costs, and control contamination costs. Parental income has the biggest effect on the IRR, 
and is the only component for which the alternative IRR falls outside of the 80\% confidence 
...
\ContinuedFloat	
	\begin{subfigure}[h]{0.8\textwidth}
	\centering
	\caption{Control Contamination Costs} \label{fig:irrf_cc_f1}
...
those for females: the IRR is insensitive to changes in public-transfer income, QALYs, health costs, and control contamination costs. 
...
is sensitive to changes in both of these components. 
...
\ContinuedFloat		
	\begin{subfigure}[h]{0.8\textwidth}
	\centering
	\caption{Control Contamination Costs} \label{fig:irrf_cc_m1}
...
\ContinuedFloat		
	\begin{subfigure}[h]{0.8\textwidth}
	\centering
	\caption{Control Contamination Costs} \label{fig:bcrf_cc_f1}
...
education costs, and control contamination costs. Barring program costs, the components that
...
\ContinuedFloat		
	\begin{subfigure}[h]{0.8\textwidth}
	\centering
	\caption{Control Contamination Costs} \label{fig:bcrf_cc_m1}
