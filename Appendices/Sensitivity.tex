\section{Sensitivity Analyses} \label{appendix:sensitivity}
...
\subsection{Varying Magnitudes of Components}
\label{app:sa_factors}

\noindent In this section, we explore how the internal rate of return (IRR) and benefit/cost ratio change as
...
This is a condequence of the different populations of males and females who were enrolled in alternative preschools.
...
observe that the estimated cost-benefit ratio is generally insensitive to changes in all the components,
...
education costs, and control substitution costs. Except for program costs, the components that
