...
\begin{table}[H]
\caption{ABC Treatment Costs per Subject} \label{tab:treat-cost}
\centering
...
\begin{threeparttable}
\small
\caption{Labor and Facilities Rental Costs of ABC Per Treated Subject} \label{tab:allprogram}
...
\noindent FPGC had rooms for infants, toddlers, and preschool-age children---each with different child-to-staff ratio. Infant nurseries had a ratio of 3:1. Toddler rooms and preschool classrooms had ratios of 4:1.\footnote{Playground and outdoor learning spaces had child-to-staff ratios of 5:1 and 6:1.} Classroom staff included teachers and teacher aides. Program staff also included administrators, researchers, and support staff (e.g. bus drivers, janitorial, and food preparation staff). We do not include the cost of research staff in our estimations. \\
