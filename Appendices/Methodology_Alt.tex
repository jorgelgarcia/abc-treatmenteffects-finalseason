...
\subsection{Testing  Assumptions~\ref{ass:exog} and ~\ref{ass:congruence}} \label{app:endogeneity}

\noindent We use the following framework to test Assumptions~\ref{ass:exog} and ~\ref{ass:congruence}. Let
