...
\noindent \textbf{[JLG: I'm working on your requests to this section.]}\\
...
\item The framework for our testable implications holds as well in this scenario. That is, it is straightforward to show that in this scenario we can write Equation~\eqref{eq:outcome} as Equation~\eqref{eq:routcome}, which is the basis of our testable implications (of invariance). The testable implications still hold empirically and are in Table~\ref{table:testablepreds}.
...
\begin{eqnarray}
Y_{k,a} &=&\gamma_{0} + \gamma_{y} Y_{k,a-1} + \gamma_{\tilde{\gamma}} \tilde{\bm{X}}_{k,a} +  \varepsilon_{a}\label{eq:linear1b} \\
\varepsilon_{a} &=& \phi + \eta_{a}, \label{eq:linear2b}
\end{eqnarray}
 
\noindent where $\eta_{a}$ is i.i.d. We follow Arellano and Bond (1991) to obtain consistent estimates of this model, as explained in Appendix~\ref{appendix:gmm}.
...
\noindent \textbf{[JLG: I'm working on your requests on this section.]}
...
\noindent We now relax Assumption ~\ref{ass:exog} (Exogeneity). Specifically, \ldots. 

\subsection{Inference} \label{appendix:bootstrap}
\noindent \textbf{[JLG: I'm working on your requests on this section.]}

\noindent This section provides the precise steps for constructing the bootstrap distribution and for computing the standard errors for three of the main estimates in our paper. \textbf{[JJH: Can we adapt this to the setting I just gave you?] [JLG: Yes. What changes is step 6 and 7 for the Predictions section. I'm providing different scenarios for this step depending on the set-up.]}
