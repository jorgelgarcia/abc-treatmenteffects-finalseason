...
\item Randomly pair individual $i'$ in $s'$ with individual $i$ in $s$. The prediction accounting for forecasting error is $\bm{Y}_{i,e,s}^d + \bm{\mathcal{E}}_{i',e,s'}^d$.
