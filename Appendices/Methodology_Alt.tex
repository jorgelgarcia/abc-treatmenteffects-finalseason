...
\textbf{[JJH: Wait, isn't this circular? Labor income at 30 is a predictor variable. Need to be careful, this looks wrong.] [JLG: Please see Table~\ref{table:explain}. Labor Income at age 30 does not predict labor income at age 30. Table~\ref{table:explain} lists what are the predictors for the predicted variables.]} 
...
\textbf{[JJH: These numbers are wildly off from \ref{table:prednlsy} and \ref{table:predcnlsy}. Why such disagreement?] [JLG: Please check these numbers, I have compressed the tables for comparability. I believe that the disagreement was due to comparing estimates from different controls sets.]}
...
\textbf{[JLG: On the Sensitivity Analysis to the Variables Used to Predict] [JJH: What is the value added of this exercise? $\bm{B}_k$ doesn't predict treatment effects - so what? This is a waste of space unless I have missed something big. $\bm{B}$ is background.] [JLG: I agree, but at some point we wanted to understand how much beyond we were able to go with $bm{X}_{a}$. Now this is not useful because we have a direct test. I have gotten rid of this.]}
...
\textbf{[JJH: Why so many for Perry and so few for ABC? And maternal income is nuts.] [JLG: The outcomes for ABC are: Employment, High School Graduation, Labor Income, Transfer Income at Age 30, and Body-Mass Index at Age 34. The outcomes for Perry are High School Graduation, Idleness, Labor Income and Reports good health.]}
...
\begin{sidewaystable}[H]
\begin{threeparttable}
\caption{Prediction of Transfer Income at Age 30 Accounting for $\bm{B}_k$ and $\bm{\theta}, \bm{X}_{k,a}$, CNLSY}
\centering
\footnotesize
