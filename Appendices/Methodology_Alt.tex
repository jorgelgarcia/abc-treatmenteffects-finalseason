...
\textbf{[JJH: My god I am going to go insane. How does this relate to the previous section? Where are results when we match on $B$? (This is ``no matching.'') Please explain how each profile is constructed!] [JJH: Jorge, this repeats the same error -- we match on $B$ not $X^d_k$. Please, I keep making the same comment. Keep getting same error.] [JLG: I have modified this, based on our discussion.]}
...
\textbf{[JJH: I do not understand this -- The reader will not --Sit down and read the paper then write it up using the paper?]}
