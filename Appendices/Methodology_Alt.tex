...
\noindent We use the following framework to test Assumptions~\ref{ass:exog} and ~\ref{ass:exogne}. Let 
...
\noindent We show an equivalent to Figure~\ref{figure:pincome} using this parental income measure.
