...
\floatfoot{
\footnotesize
Note: Benefit/cost ratio as a function of diverse earnings-returns to a standard deviation of a kindergarten IQ test.
}
\end{figure}
\end{center}
...
\floatfoot{
\footnotesize
Note: Benefit/cost ratio as a function of diverse net present value of earnings.
}
\end{figure}
\end{center}