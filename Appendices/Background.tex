...
\begin{tablenotes}
\item Note: This table shows the means of the subsets of control-group subjects in ABC/CARE who were and were not enrolled in alternative preschool. The number of subjects in these groups are listed at the top of the table. Standard errors are in parentheses.
\end{tablenotes}
\end{threeparttable}
\end{table}
