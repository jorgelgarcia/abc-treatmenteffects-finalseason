...
\item $\bm{^*}$As documented in Appendix~\ref{app:eligibility-pop}, there were losses in the initial samples due to death, parental moving, and diagnoses of mental pathologies for the children.\\
\item $\bm{^{**}}$ We do not analyze this sample in this paper and mention it only for completeness.
\end{tablenotes}
\end{threeparttable}
\end{adjustbox}
\end{table}
