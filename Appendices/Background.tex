...
\begin{tablenotes}
\item Note: This table shows the means by gender of the subsets of control-group subjects in ABC/CARE who were and were not enrolled in alternative preschool. The number of subjects in these groups are listed at the top of the table. Standard errors are in parentheses. The reported $p$-values are from two-sided tests of difference of means. The means are bolded if the difference is significant at the 10\% level. 
\end{tablenotes}
\end{threeparttable}
\end{sidewaystable}
