...
\noindent \textbf{[JJH: Put in footnote at Base of 3/4.] [JLG: If we do that, then the figure looks very small and it is much harder to read. I can still compress the figures if you want the notes at the base.]}

\noindent \textbf{[JJH: Jorge - in text we sat 120] [JLG: Initially, there were 120 families (123 subjects). After removing 2 subjects who were mentally disabled (rows 18 and 19 of Table A.2), 4 subjects who left the study (rows 1 through 4 of Table A.2), and 3 subjects who died before 6 months (rows 5 through 7 of Table A.2), there are 114 subjects from 112 families who are considered part of the initial sample. We used to say that we had an initial sample of 111 subjects. We updated the initial sample to reflect what we do in the data. This error is not in the gender differences paper, but was in its appendix. We corrected the appendix so that there are no mentions of 111 subjects.]}
