...
\noindent \textbf{[JLG: The values in the table are now in 2014 USD.]}\\
\noindent \textbf{[JLG: See attachment for treatment effects interacting with HRI. I don't think we have done this before for ABC.]}\\
...
\indent \textbf{[JJH: Do we ever distinguish the effects of subsidized childcare from non-subsidized childcare?] [JLG: This was one of the first intends we did to control for substitution. The cells get so thin that the exercise is nuts.]}
...
\textbf{[JJH: How important is this on CBA?]}
\textbf{[JLG: Note that this is a cost to the control group. Put differently, the implementation of ABC/CARE saves money spent of this. Having said so, in Table  5 of the main paper we report the following exercise. Suppose that alternative preschools had cost zero. For males the IRR [B/C] ratio are: .14 [11.08]. For females the IRR [B/C] ratio is .08 [2.16]. For the pooled sample the IRR [B/C] are .11 [5.76]. We are safe here.]}
