...
\noindent \textbf{[JJH: I wont sign off unless we have a coherent story.] [JLG: We haven't asked you to sign off. We want to have a good study not a rotten publication.]}\\ 
...
\noindent \textbf{[JJH: Jorge, at the risk of facing another explosion, let me repeat my question which I have asked repeatedly and have not had answers.] [JLG: Please see the answers below.]}\\ 

\noindent \textbf{[JJH: Are family environments (other than HOME scores) changed by treatment?] [JLG: Yes. Apart from HOME scores, the other measure of family environment that we have is income. Both HOME scores and family income are positively affected by ABC/CARE.]} \\

\noindent \textbf{[JJH: Is part of the better female treatment effects due to better environments at home for girls?] [JLG: Yes. Improved environments. Part of the better female treatment effects is due to the worse environments at home for girls than boys. The control-group boys are more advantaged than the control-group girls. This is consistent with there being more positive treatment effects for females.] [JJH: I keep asking the same question - Better environments for treatment-group girls?] [JLG: Yes. Read the answers. It says ``Yes. Improved environments.'']}\\

\noindent \textbf{[JJH: More mothers induced to work for girls?] [JLG: Yes. A larger percentage of control boys have working mothers at baseline, so the treatment effects on maternal employment are generally larger for girls than for boys.] [JJH: Ah - an answer.]} \\

\noindent \textbf{[JJH: more family income?] [JLG: Yes. The treatment results in more family income. This is shown in Tables 1 and 4. The effect on family income is larger for boys than for girls. Remember that more boys have fathers at home than girls. The fact that the treatment effect on maternal employment is larger for girls is not inconsistent with the treatment effect on family income being larger for boys.] [JJH: Male income income up and female employment up?] [JLG: No. This is based on mother. Father's data on income is garbage. It was less than 20 observations.]} \\

\noindent \textbf{[JJH: More fathers coming back to an improved environment?] [JLG: No. Treatment does not induce fathers to ``come back,'' although families with fathers present are more advantaged along other measures, e.g., family income.] [JJH: OK.]} \\

\noindent \textbf{[JJH: You said we did not know father's income at baseline When is father'۪s income measured?] [JLG: It is measured at ages 12 and 21, although there are very few observations (28 and 4, respectively).] [JJH: Use this! Are fathers working more.] [JLG: We do now know if they work more. And these are 28 and 4 observations. How can we use 4 observations? Even 28 is very very bad. We have 8 controls. This would not be serious and we cannot detect anything when we do it anyway.]} \\

\noindent \textbf{[JJH: Do we know if father present at baseline? Yes or so it seems] [JLG: Yes. Whenever the paper refers to father's presence, it is at baseline.]}\\ 

\noindent \textbf{[JJH: Do we know if fathers increase their presence at home if the son is in treatment?] [JLG: Fathers do not increase their presence at home if the son is in treatment. This is evident in Figure 1 of the old, submitted draft. This is attached.]}\\

\noindent \textbf{[JJH: Do we know this question for daughters?] [JLG: Fathers do not increase their presence at home if the daughter is in treatment. It is actually the case that more fathers are home for control girls than treatment girls. This difference is only statistically significant at age 4.5 when 17\% of the treatment girls have fathers present (observed for 30 subjects) and 31\% of the control girls have fathers present (observed for 36 subjects). Please note that at this age, the number of observations of fathers present is very small.]}\\

\noindent \textbf{[JJH:  Do we know differential treatment effects?] [JLG: As you can see in the previous answer, we don't have great measures of disadvantage after baseline. However, as Tables 1 and 4 show, ABC/CARE differentially affects parental income and parenting by gender. The effects on parental income are larger for boys than for girls. The effects on parenting are larger for girls than for boys.]}\\ 

\noindent \textbf{[JJH: To what extent does treatment improve family incomes of treatment relative to control?] [JLG: This is displayed in Table 4 and the differential effect in Table 1.]}\\ 

\noindent \textbf{[JJH: More mothers are INDUCED to work above baseline correct?] [JLG: Yes. Treatment increases maternal employment by about 10\%. A larger percent of control boys have working mothers at baseline, so the treatment effects on maternal employment are generally larger for girls than for boys.]}\\

\noindent \textbf{[JJH: Is the greater family income of treatments from the mothers or the INCREASE in the presence of the father] [JLG:  When fathers stay at home, the family income increases. Unfortunately, we do not have good documentation of who this family income is coming from, so it is hard to determine the exact effect of the father. It is possible that the father provides additional income. It is also possible the father provides childcare (or additional relatives who can provide childcare) allowing the mothers to work more or in better jobs.]}\\

\noindent \textbf{[JLG: We do not have gender of other siblings. Ideally, we would have a time series of the measure of disadvantage for each child. I think we both agree on that. But we don't have that. We do have: A time series of the home score, for which we do have results in the paper both in Table 1 and Table 4, which are by gender and comparing boys and girls. We call this "parenting" in the paper. Parental income:  which is an aggregate of mother's, father's and both mother and father income. The reason for using the different variables is that at different ages we observe different variables. For this we also present results by gender and comparing genders in Tables 1 and 4.]}

\end{comment}

\begin{center}
\noindent {\centering \textbf{Memo: June 14, 2018}}
\end{center}

\noindent \textbf{[JJH: We want to know Why the Treatment effects are bigger for girls.] [JLG: Yes. I agree and the evidence indicates, as you pointed out yesterday, that the environments are improving more for girls than for boys. This is in terms of growth.]}\\ 

\noindent \textbf{[JJH: We know at baseline Girls are in worse circumstances.] [JLG: Yes.]}\\

\noindent \textbf{[JJH: What we want to know is why they IMPROVE That involves analyses BEYOND baseline.] [JLG: Yes. Please see Table~\ref{table:massiveall} in this document. In terms of the environment of girls and boys we have the income and labor supply of their mother and the HOME scores (which include interaction with both the mother and the father, when the father is around). This is extracted from the paper, but may be clearer when considered separately. These two aggregates post-baseline, as described in the table. The reason why we aggregate this is because otherwise the estimates get very noisy.]}\\

\begin{sidewaystable}[H]
\begin{threeparttable}
\caption{Excerpt from Table 4: Combining Functions and Exact Non-Parametric Tests} \label{table:massiveall}
\centering
\begin{tabular}{l c c c c}
\toprule
 & Average & \% $ >0 $ & \% $ >0 $ , Significant & Rosenbaum \\
 & Effect Size & Treatment Effect & Treatment Effect & $ p $ -value \\
\midrule
\textbf{Parental Income} & \mc{4}{c}{[Parental income (1.5, 2.5, 3.5, 4.5) and mother works (1.5, 2.5, 3.5, 4.5)]} \\
 &      & &    & \\
\quad Females & \textbf{    0.283} & \textbf{  100.000} & \textbf{   75.000}  & \textbf{ 0.086} \\
\quad Males &  \textbf{    0.157} & \textbf{  100.000} & \textbf{   37.500}  & 0.147 \\
\midrule
\textbf{Parenting} & \mc{2}{c}{[HOME scores (0.5, 1.5, 2.5, 3.5, 4.5)]} & & \\
 &      & &    & \\
...
\begin{tablenotes}
\footnotesize
\item \textbf{Note:} This table displays summaries of treatment effects by outcome category and gender. Each of the panels contains statistics calculated using outcomes grouped by category. The average effect size is calculated by averaging over the effect size of the outcomes in the outcome category. The effect sizes of the individual outcomes are calculated by dividing the treatment-control mean difference by the standard deviation of the control group. We present bootstrapped $p$-values. For the proportion of outcomes that are positive and significant, we do a ``double bootstrap'' procedure. The null hypothesis for the average effect sizes is that they are 0. The null hypothesis for the proportion of outcomes that are (significantly) positive is that they are (10\%) 50\%. Bolded statistics are significant at the 10\% level. The Rosenbaum $p$-value originates from a test where the null is a common joint distribution of the variables in each category. For computational simplicity, we approximate the exact $p$-values using asymptotic $p$-values. Rosenbaum (2005) presents several simulation exercises showing that the validity of this approximation. Statistics significant at the $0.10$ level are bolded.
\end{tablenotes}
\end{threeparttable}
\end{sidewaystable}

\noindent \textbf{[JJH: You seem bound and determined to stay at baseline and that's non-responsive to the questions of the referees and to fundamental curiosity and scientific discourse.] [JLG: No. I want to show post-baseline, as indicated in the previous Table~\ref{table:massiveall}. Now, father's income comes next.]}\\

\noindent \textbf{[JJH: You are some saying 28 observations is too small It may be But please I understand samples may be small I understand you would like more So would I But please understand that a baseline only analysis is essentially unsatisfactory It does not  explain CHANGE except possibly through an interaction.] [JLG: Yes. But I think we should construct that story based on Table~\ref{table:massiveall} in this document and not on father's income, for which you can see the results next in Table~\ref{table:father} in this document. Now, one could ask why not add father income into the aggregates in Table~\ref{table:massiveall} in this document. The reason is that if we do so the number of observations drops so much and we are back in trouble.]}\\ 

\begin{table}[H]
\begin{threeparttable}
\caption{Description of Father's Income} \label{table:father}
\centering
\begin{tabular}{l c c c c c c}
\toprule
& Age & \mc{2}{c}{$N$} & \mc{2}{c}{Mean} & $\Delta$ \\
\cmidrule(lr){3-4} \cmidrule(lr){5-6}
& 	& Control & Treatment & Control & Treatment & \\
\midrule
Males & 12 & 8 & 8 & $25,466.05$ & $25,147.62$ & -318.43 \\
 & 21 & 0 & 4 & --- & $11,507.50$ & --- \\
 \midrule
Females & 12 & 7 & 5 & $26,466.40$ & $52,612.00$ & $26,145.60$ \\
 & 21 & 0 & 0 & --- & --- & --- \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\footnotesize
\item \textbf{Note:} This table describes father's income by treatment status, displaying age of measurement, number of observations in each treatment regime, control and treatment means, and average treatment effect. Both variables are only available for subjects in ABC (not CARE). All values are in 2014 USD.
\end{tablenotes}
\end{threeparttable}
\end{table}

\noindent \textbf{[JJH: You seem to think I do not understand that you have analyzed baseline I do understand very well now although the writing in previous drafts was exceedingly unclear.] [JLG: No. I am just trying to clarify things in response to the questions, but I mean no disrespect.]}\\ 

\noindent \textbf{[JJH: But now we need more however imperfect.] [JLG: I think that the parental income and HOME scores tell the story.]}\\ 

\noindent \textbf{[JJH: The story in 5 is weak and any fragments will help Read what I wrote carefully.]}
