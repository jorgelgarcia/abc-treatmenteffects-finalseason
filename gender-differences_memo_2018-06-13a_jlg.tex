...
\noindent \textbf{[JJH: We want to know Why the Treatment effects are bigger for girls.] [JLG: Yes. I agree and the evidence indicates, as you pointed out yesterday, that the environments are improving more from girls than for boys. This in terms of growth.]}\\ 

\noindent \textbf{[JJH: We know at baseline Girls are in worse circumstances.] [JLG: Yes.]}\\

\noindent \textbf{[JJH: What we want to know is why they IMPROVE That involves analyses BEYOND baseline.] [JLG: Yes. Please see the following table. In terms of the environment of girls and boys we have the income and labor supply of their mother and the HOME scores (which include interaction with both the mother and the father, when the father is around). This is extracted from the paper, but maybe clearer when considered separately in this table which we can display in Section 5. This two aggregates post-baseline, as described in the table. The reason why we aggregate this is because else the estimates get very noisy.]}\\


\noindent \textbf{[JJH: You seem bound and determined to stay at baseline and that's non-responsive to the questions of the referees and to fundamental curiosity and scientific discourse.] [JLG: No. I want to show post-baseline, as indicated in the previous table. Now, father's income come next.]}\\

\noindent \textbf{[JJH: You are some saying 28 obersvations is too small It may be But please I understand samples may be small I understand you would like more So would I But please understand that a baseline only analysis is essentially unsatisfactory It does not  explain CHANGE except possibly through an interaction.] [JLG: Yes. But I think we should construct that story based on the Table above and not on father's income, for which you can see the results next. Now, one could ask why not add this to the aggregates in the Table above. The reason is that if we do so the number of observations drops so much and we are back in trouble.]}\\ 

\noindent \textbf{[JJH: You seem to think I do not understand that you have analyzed baseline I do understand very well now although the writing in previous drafts was exceedingly unclear.] [JLG: No. I am just trying to clarify things for you when the questions come by, but I mean no disrespect.]}\\ 
...
\noindent \textbf{[JJH: The story in 5 is weak and any fragments will help Read what I wrote carefully.] [JLG: .]}\\ 
