...
Finally, we test whether estimated treatment effects are equal across genders. Table~\ref{table:genderdifference-tes} reports the two-sided $p$-values testing if the estimates in (1) of Tables~\ref{table:tescombinedmales} and~\ref{table:tescombinedfemales} are equal. Males have larger treatment effects on parental income at age 21, labor income, drug use, and on the measures of blood pressure. The treatment effects are significantly different for years of education, diastolic blood pressure, and hypertension. \textbf{[JJH: What happens for full 95?]}

\begin{sidewaystable}[!htbp]
\textbf{[JJH: There are few gender differences! I thought we found more. The paper collapses with this table. Do a rank sign test.]}
\centering
\begin{threeparttable}
