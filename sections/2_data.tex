...
Figure~\ref{fig:family-over-time} gets at one aspect in which the subjects were disadvantaged. For a more detailed description of the sample's disadvantage, see Appendix~\ref{appendix:background}. The figure shows the evolution of the fathers' presence over time. At birth, there were few fathers present, especially for the females in the treatment group. After birth, the proportion of fathers present, conditional being present at birth, remains stable.

\textbf{[JJH: This goes in web appendix. Look at \underline{controls} outcomes: male vs female. Then treatment effects (value added). How much is the gap closed?][We moved the table to the appendix. The analysis you request is now explained in the introduction and Section 6.]}

\begin{figure}[H]
\textbf{[JJH: Father Present?][Yes. Title is now changed.] [JJH: Verbally summarize; too busy.][We adjusted this figure accordingly.]}
\begin{center}
...
\textbf{[JJH: Appendix.][We moved the section summarizing the data collection to the appendix.]}
