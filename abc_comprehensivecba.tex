...
\begin{assumption} (Conditional Independence and Sufficiency of $S, X, W, R$ to Describe Presence in a Dataset)
\begin{equation}
...
\noindent Next, we analyze the estimates when splitting the sample by males and females. Most of the estimates loose significance due to the reduction of observations after splitting the sample by gender. However, it is important to note that for both males and females, the estimates remain robust across the different instances of the sensitivity analysis.\\
