...
\end{equation*}
\end{assumption}
i.e., treatment effects operate through inputs and not shifts in the input-output functions. Evidence for this assumption in the context of early childhood programs is presented in \citet{Heckman_Pinto_etal_2013_PerryFactor} and \citet{Attanasio-etal_2015_NBER_Estimating-Production}. Appendix~\ref{appendix:pred} displays evidence favoring this assumption using each of the synthetic treatment and control groups we construct, i.e. based on different non-experimental samples.
