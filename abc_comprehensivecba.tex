...
\end{subfigure}
\footnotesize \justify
Note: Panels (a) displays the predicted labor income life-cycle profiles for ABC/CARE for females by treatment status, based on the method proposed in this section. We combine data from the Panel Study of Income Dynamics (PSID), the National Longitudinal Survey of Youth 1979 (NLSY79), and the Children of the National Longitudinal Survey of Youth 1979 (CNLSY79). We highlight the \textit{realized or observed} labor income at $t^*$ (age 30) for the ABC/CARE control- and treatment-group participants. Panel (b) displays the analogous exercise for males. Standard errors are based on the empirical bootstrap distribution.
\end{sidewaysfigure}

\indent In the experimental sample, the parents of children with observed characteristics $\bm{B} \in \mathcal{B}_0$ generally accept to participate of the program. Given that in the non-experimental sample there is no treatment, a test of validity of our matching procedure is to compare the dynamic relationship in the non-experimental individuals such that  $\bm{B} \in \mathcal{B}_0$ to the synthetic control group we construct (i.e., the group in the non-experimental sample that we match on observed characteristics to the control group in the experimental sample). We can also compare labor income at $t^*$ of these two groups to the observed labor income in the experimental sample (we observe labor income at $t^*$). Figure~\ref{figure:controltests} displays these comparison. We plot the labor income of individuals in our non-experimental sample such that $\bm{B} \in \mathcal{B}_0$ and the synthetic control group from ages 20 to 45. We also highlight the labor income of the experimental control group at $t^*$ (age 30). We stop at age 45 because we do not observe individual characteristics in the non-experimental sample to construct the ABC/CARE high-risk index defining $\bm{B} \in \mathcal{B}_0$. 

Another test we can implement at $t^*$ is to compare the predicted labor income based on the synthetic control and treatment groups with the realized labor income for the ABC/CARE control- and treatment-group participants. Figure~\ref{fig:labor-income-profiles} displays the prediction of labor income over the life cycle for the treatment and control groups, and highlights realized or observed labor income at  $t^*$. In neither of the tests can we reject differences that question the validity of our method to construct synthetic treatment and control groups.

\begin{sidewaysfigure}[!htbp]
\centering
\caption{Labor Income Profile, Synthetic Cohoers and Disadvantaged Individuals in the Non-experimental Samples}\label{figure:controltests}
\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\caption{Females} 
...
When adequately assessed, findings indicate that early childhood education programs enhance human development in that they provide a vehicle to promote social mobility.
