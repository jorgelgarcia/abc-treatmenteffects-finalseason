...
\begin{sidewaysfigure}[!htbp]
\centering
\caption{Predicted Labor Income Profiles for ABC/CARE Participants \textbf{[JJH: still a big gap!] [We now have the comparison the difference between treatment and control in experimental and non-experimental samples. We cannot reject the null hypothesis that this difference is 0. This is added to the figure note.]}}\label{fig:labor-income-profiles}
