...
The benefit/cost ratio and internal rate of return calculations both indicate that males and females benefit \texit{differently} from the program. There are two complementing stories to reconcile this difference. First, males benefit the most from components that we are able to monetize. Examples include 



A first reson for th
