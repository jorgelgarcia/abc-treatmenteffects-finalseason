...
Evidence from these programs is highly relevant for contemporary policy discussions because their main components are present in a variety of current interventions. Furthermore, about 19\% of all African-American children would be eligible for ABC/CARE today.\footnote{According to the authors' calculations using the Panel Study of Income Dynamics (PSID), 43\% of African-American children were eligible in 1972.} \textbf{[AZ: move this elsewhere?]}
...
\textbf{[JJH: We need to adapt to CBA] [JLG: I gave it a shot, trying to avoid cluttering.]}
...
We discuss our measures of educational attainment and costs in  Appendix~\ref{appendix:education}. 
