...
\begin{center}
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=.8\columnwidth]{output/abc_Diagram.pdf}
\floatfoot{
\footnotesize
\noindent
...
\begin{center}
	\begin{figure}[H]
		...
		\centering
		\includegraphics[width=.95\columnwidth]{output/care_Diagram.pdf}
\floatfoot{
\footnotesize
\noindent
