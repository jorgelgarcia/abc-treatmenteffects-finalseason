...
\caption{Family Education vs. Control Groups, CARE Cohort 6 \label{tab:baseline_coh6_care_t1}}
  ...
  \end{tabular}
    ...
    \scriptsize
    \item 
    Note: This table shows the balance in observed characteristics between the family education group and the control group in CARE at baseline for cohort 6.
