...
\draw (-4.25,2) node[align=center, below] {\large 3.4\% \\ \large  1.2 }; 		%A
...
\draw (-2.5,3.5) node[align=center, below] {\large 4.6\% \\ \large 1.7 }; 						%AB
\draw (-.5,-1.5) node[align=center, below] {\normalsize \textit{\textbf{10.7\%}} \\ \normalsize \textit{\textbf{2.3}} }; 				%AC
\draw (2,-2.5) node[align=center, below] {\normalsize \textit{\textbf{6.4\%}}  \\ \normalsize  \textit{\textbf{2.5}} }; 						%AD
\draw (1.75,3.75) node[align=center, below] {\large 6.1\% \\ \large 1.7 }; 					%BC
\draw (4.25,-1.5) node[align=center, below] {\normalsize 4.5\% \\ \normalsize 1.9 }; 						%BD
\draw (5.5,3.5) node[align=center, below] {\large \textit{\textbf{8.7\%}}  \\ \large \textit{\textbf{2.5}}}; 			%CD
\draw (0.25, 1.75) node[align=center, below] {\large 8.5\% \\ \large \textit{\textbf{2.9}}  }; 					%ABC
\draw (3.25,-1.9) node[align=center, below] {\small \textit{\textbf{6.3\%}} \\ \small \textit{ \textbf{3.1}}}; 						%ABD
\draw (0.72,-2.07) node[align=center, below] {\small \textit{\textbf{11.4\%}} \\ \small \textit{\textbf{3.7} } }; 			%ACD
\draw (3.25, 1.75) node[align=center, below] {\large \textit{\textbf{8.2\%}} \\ \large \textit{\textbf{3.06}}}; 					%BCD
