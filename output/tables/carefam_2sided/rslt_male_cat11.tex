...
\caption{CARE Average Treatment Effects, Males \\ Hypertension \label{tab:ate_male_apx11}}
  ...
  \hline\hline
    ...
    \\[0.1cm]
    \mc{2}{l}{\scriptsize{\% of Sig. TE ($H_0$: $\le$ 25\% $|$ 10\% Significance)}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} &  & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} &  \\  
    ...
    \mc{2}{l}{\scriptsize{\% of Sig. TE ($H_0$: $\le$ 50\% $|$ 10\% Significance)}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} &  & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} &  \\  
