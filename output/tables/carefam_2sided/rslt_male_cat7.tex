...
\caption{CARE Average Treatment Effects, Males \\ Employment and Income \label{tab:ate_male_apx7}}
  ...
  \hline\hline
    ...
    \mc{1}{l}{\scriptsize{Labor Income}} & \mc{1}{c}{\scriptsize{21}} & \mc{1}{c}{\scriptsize{-3,122}} & \mc{1}{c}{\scriptsize{-3,165}} & \mc{1}{c}{\scriptsize{-6,664}} & \mc{1}{c}{\scriptsize{-3,352}} & \mc{1}{c}{\scriptsize{-7,471}} & \mc{1}{c}{\scriptsize{-2,478}} & \mc{1}{c}{\scriptsize{-2,496}} & \mc{1}{c}{\scriptsize{-2,243}} \\  
     ...
     & \mc{1}{c}{\scriptsize{30}} & \mc{1}{c}{\scriptsize{-4,091}} & \mc{1}{c}{\scriptsize{-8,143}} & \mc{1}{c}{\scriptsize{-2,504}} & \mc{1}{c}{\scriptsize{-9,126}} & \mc{1}{c}{\scriptsize{-4,534}} & \mc{1}{c}{\scriptsize{-4,488}} & \mc{1}{c}{\scriptsize{-7,553}} & \mc{1}{c}{\scriptsize{-7,649}} \\  
    ...
    \mc{1}{l}{\scriptsize{Public-Transfer Income}} & \mc{1}{c}{\scriptsize{21}} &  &  &  &  &  &  &  &  \\  

     &  &  &  &  &  &  &  &  &  \\  

     & \mc{1}{c}{\scriptsize{30}} & \mc{1}{c}{\scriptsize{935}} & \mc{1}{c}{\scriptsize{818}} & \mc{1}{c}{\scriptsize{935}} & \mc{1}{c}{\scriptsize{1,265}} & \mc{1}{c}{\scriptsize{1,030}} & \mc{1}{c}{\scriptsize{935}} & \mc{1}{c}{\scriptsize{692}} & \mc{1}{c}{\scriptsize{907}} \\  
    ...
    \\[0.1cm]
    \mc{2}{l}{\scriptsize{\% of Sig. TE ($H_0$: $\le$ 25\% $|$ 10\% Significance)}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{50}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} \\  
    ...
    \mc{2}{l}{\scriptsize{\% of Sig. TE ($H_0$: $\le$ 50\% $|$ 10\% Significance)}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{50}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} \\  
    ...
    \mc{2}{l}{\scriptsize{\% of Sig. TE ($H_0$: $\le$ 75\% $|$ 10\% Significance)}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{50}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} & \mc{1}{c}{\scriptsize{25}} & \mc{1}{c}{\scriptsize{0}} \\  
