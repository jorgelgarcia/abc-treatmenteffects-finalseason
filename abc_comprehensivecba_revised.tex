...
\begin{remark}
This assumption includes accurate adjustments for cohort effects. We only require distributions of forecast variables to make accurate forecasts not knowledge of individual values.
\end{remark}
\doublespacing
