...
\thispagestyle{empty}
\begin{abstract}
\noindent This paper quantifies the life-cycle benefits of a widely emulated high-quality intensive early childhood program that starts early in life (at 8 weeks of age). Guided by economic theory, we supplement experimental data with non-experimental data to forecast the life-cycle benefits and costs of the program. Our baseline estimate of the internal rate of return (benefit/cost ratio) is 13.7\% (7.3). We account for model estimation and forecasting error. Our results are robust to sensitivity analyses for our estimates of the empirical magnitudes of numerous non-market benefits of the program. Our paper is a template for synthesizing experimental and non-experimental data to estimate life cycle benefits of social programs. 
\end{abstract}
...
\noindent A large body of evidence documents that high-quality early childhood programs are effective in promoting the skills of disadvantaged children.\footnote{See \citet{Blau_Currie_2006_HEE}, \citet{Cunha_Heckman_ea_2006_HEE}, \citet{Duncan_Magnuson_2013_JEP}, \citet{Almond-Currie_2011_JEP}, and \citet{Elango_Hojman_etal_2016_Early-Edu} for surveys.} Much of this research estimates benefits in terms of cognitive test scores and measures of social behavior early in life. In a few papers, longer-term benefits in completed education, adult health, crime, and labor income are reported.\footnote{Examples include: \citet{Heckman_Moon_etal_2010_QE}, \citet{Havnes_Mogstad_2011_AEJEP}, and \citet{Campbell_Conti_etal_2014_EarlyChildhoodInvestments}.} A recurring finding is that impacts on socio-emotional skills, rather than on cognitive skills, are primary mediators of long-run gains.\footnote{See \citet{Heckman_Pinto_etal_2013_PerryFactor} and \citet{Almond_etal_2017_Childhood_UNPUBLISHED}.} Rigorous evidence on the long-term economic benefits of these programs is scarce.\footnote{An exception to this in the economics literature is \citet{Heckman_Moon_etal_2010_RateofReturn}, who present a cost-benefit analysis of the Perry Preschool Program. Our approach is more comprehensive in terms of outcomes analyzed and, more importantly, in providing a methodology that could be replicated to assess the social efficiency of any other program.} Investment in high-quality early childhood education is only justified if the social benefits exceed the  social costs.

This paper investigates the social efficiency of an influential pair of programs that target disadvantaged children. We analyze two virtually identical early childhood programs evaluated by randomized controlled trials with long-term follow up through the mid 30s \textbf{[JLG: It is not 34. The so-called 34 follow-up took years. The average response was at 35.]} They were conducted in North Carolina: the Carolina Abecedarian Project (ABC) and the Carolina Approach to Responsive Education (CARE)---henceforth ABC/CARE. Both programs were launched in the 1970s. The programs began early (at 8 weeks of life) and engaged participants until age 5. Children benefited from treatment. Their parents (primarily mothers) received free childcare that enabled employment earnings and adult education. We estimate a $13.7\%$ per-annum internal rate of return and a $7.3$ benefit/cost ratio for ABC/CARE.

ABC/CARE is widely emulated.\footnote{Programs inspired by ABC/CARE have been (and are currently being) launched around the world. \citet{Sparling_2010_Highlights} and \citet{Ramey_Ramey_Lanzi_2014_Interventions} list numerous programs based on the ABC/CARE approach. The programs are: Infant Health and Development Program (IHDP) in eight different cities in the U.S. \citep{Spiker-etal_1997_Helping}; Early Head Start and Head Start. \citep{Schneider_McDonald-eds_2007_Scale-Up_Vol-1}; John's Hopkins Cerebral Palsy Study in the U.S. \citep{Sparling_2010_Highlights}; Classroom Literacy Interventions and Outcomes (CLIO) study. \citep{Sparling_2010_Highlights}; Massachusetts Family Child Care Study \citep{Collins_etal_2010_Massachusetts-Study}; Healthy Child Manitoba Evaluation \citep{Healthy_Child_Manitoba_2015_Starting-Early}; Abecedarian Approach within an Innovative Implementation Framework \citep{Jensen_Nielsen_2016_ABC-Programme-Pilot}; and Building a Bridge into Preschool in Remote Northern Territory Communities in Australia \citep{UMonash_Dataset_2015_URL}. Current Educare programs in the U.S. are also based on ABC/CARE \citep{Educare_2014_Research_Agenda,Yazejian_Bryant_2012_Educare}. Appendix~\ref{app:details-educare} lists these Educare programs, all of which implement curricula based on ABC/CARE.} It has high staff-to-child ratios, active monitoring of children, and provides childcare to mothers. About 19\% of all African-American children would be eligible for ABC/CARE today; 43\% of African-American children were eligible at its inception. The program is a prototype for many programs in place today. Implementation of ABC/CARE on disadvantaged populations could be an effective and socially efficient strategy for promoting social mobility.\footnote{In \citet{Garcia_2016_National-Implementation-ECI}, we report that if ABC/CARE were implemented to the current pool of eligible children in the population, the intra-black (black disadvantaged to black advantaged) gap in high-school graduation, years of education, employment and labor income at age 30 for females will be reduced by $110\%$, $76\%$, $22\%$, and $30\%$, respectively. This would eradicate the high-school graduation gap, reduce the years of education gap to 0.12 years, reduce the employment gap to 14 percentage points, and reduce the labor income gap to 4,075 USD (2016). \textbf{[JJH: Let me see this paper.] [JLG: printed for you.]} For males, this would eradicate the intra-black high-school graduation gap, reduce the years of education gap to 0.18 years, reduce the employment gap to 9 percentage points, and reduce the labor income gap to 12,150 USD (2016).} We address a fundamental problem in evaluating social programs. The oldest experimental subject is in his mid 30s. We want to examine life cycle returns. We do so by supplementing the experimental data with non-experimental data on comparable older cohorts.

The experiment collects annual observations on a variety of outcomes from ages 0 to 15. During adulthood, information is only collected in certain years but includes, for example, labor income, a full medical sweep, and administrative criminal records through the mid 30s. We forecast the life-cycle benefits and costs of the program using economic theory to guide construction of later life outcomes using non-experimental data.\footnote{\citet{Ridder_Moffitt_2007_hbk_metricsdata} provide a discussion of data combination methods. These methods are related to the older ``surrogate marker'' literature in biostatistics (see e.g.,\ \citealp{Prentice_1989_Surrogate_SiM}). However, as we note below, exogeneity is an integral part of the models we estimate, although it is not considered in the statistics literature. That literature does not provide testable predictions to validate the forecasts, which we produce using structural models.} We compute internal rates of return and benefit-cost ratios accounting for the large array of benefits and costs generated. We account for model estimation and forecasting error and the welfare cost of taxation. Our estimates are robust when subject to extensive sensitivity analyses.

The analysis proceeds in the following way. We construct a synthetic cohort from non-experimental samples that approximates the experimental sample in post-experiment years. We use economic theory to formulate and estimate invariant production functions of program treatment effects.\footnote{Our forecasts impose an economic model where the observed difference between the treatment and control groups in long-term outcomes is generated by the experimentally-induced difference in intermediate inputs. At age 22, for example, the treatment effect on labor income is generated by the treatment effects on an achievement test, years of schooling, and labor income at age 21. This extends on the methodology of \citet{Heckman_Pinto_etal_2013_PerryFactor}, whose objective is to  relate intermediate and long-term outcomes in a mediation analysis framework. They do not pursue the forecasting objective that we pursue.} The production functions depend on intermediate inputs which we observe in both experimental and non-experimental samples.\footnote{A companion paper, \citet{Garcia_Heckman_Ziff_2017_Gender-Diff_UNPUBLISHED}, documents treatment effects on these inputs resulting from ABC/CARE. For example, assignment to treatment increased college graduation for males by 17 percentage points, with a standard error of 5 percentage points and where the college graduation rate for the control group is 12\%. For females, assignment to treatment increased high school graduation by 25 percentage points, with a standard error of 1 percentage point and where the high school  graduation rate for the control group is 53\% points. These results are the basis of our forecasts: We document that education is the main intermediate input when forecasting benefits across the life cycle.} We test invariance using non-experimental samples that overlap, in part, with the experimental sample. We forecast post-experimental treatment effects by evaluating the predictions of our model in the non-experimental data. We adjust for forecast and estimation error.

Our analysis is a template for estimating the life-cycle gains of social experiments for which there is less than full lifetime follow-up. It is generally true that the analyst cannot wait for the participants of social programs to age so that full lifetime outcomes are available. Policy makers cannot wait either. In this context, supplementing experimental data with non-experimental data using economic and econometric theory becomes a powerful tool. The desire to answer policy questions has recently led to informal and \textit{ad hoc} procedures for estimation of long-term benefits based on short-term measures of childhood test scores \citep[e.g.][]{Kline_Walters_2016_QJE}. We show how misleading these practices can be.

The paper unfolds in the following way. Section~\ref{section:background} describes the ABC/CARE program. Section~\ref{section:cbamethodology} discusses our methodology to forecast life-cycle outcomes and the evidence supporting our assumptions. Section~\ref{section:cbapractice} discusses practical aspects of applying our methodology. Section~\ref{section:cbaresults} reports our baseline estimates of internal rates of return and benefit/cost ratios. It also reports an array of sensitivity analyses. Section~\ref{section:cbaresultscont} presents social efficiency measures comparing the program to alternative preschool programs that most of the control-group parents decided to use and comparing the program to staying at home. Section~\ref{section:bcaestimates} examines the predictive validity of \emph{ad hoc} forecast methods currently used in the literature to estimate the long-term benefits of programs with short-term follow up. Section~\ref{section:conclusion} summarizes and contextualizes our findings.

\section{ABC/CARE: Background} \label{section:background}

The Carolina Abecedarian Project and the Carolina Approach to Responsive Education (ABC/CARE) was an enriched childcare center that targeted the early years of disadvantaged, predominately African-American children in Chapel Hill, Durham, and Raleigh in North Carolina.\footnote{Both ABC and CARE were designed and implemented by researchers at the Frank Porter Graham Center of the University of North Carolina in Chapel Hill.} Appendix~\ref{appendix:background} describes the program in detail. Here, we summarize its main features.

The goal of these programs was to enhance the life skills of disadvantaged children. Both programs supported language, motor, and cognitive development as well as socio-emotional competencies considered crucial for school success including task orientation, the ability to communicate, independence, and pro-social behavior.\footnote{\citet{Sparling_1974_Synth_Edu_Infant_SPEECH, Ramey_Collier_etal_1976_CarolinaAbecedarianProject, Ramey_etal_1985_Project-CARE_TiECSE, Wasik_Ramey_etal_1990_CD, Ramey-etal_2012-ABC}.} The programs provided health screenings to treatment group members, but health care costs were paid by parents.
...
The design and implementation of ABC and CARE were very similar. Both had two phases, the first of which lasts from birth until age 5. In this phase, children were randomly assigned to treatment. The second phase of the study consisted of child academic support through home visits from ages 5 through 8. The first phase of CARE, from birth until age 5, had an additional treatment arm of home visits designed to improve home environments.\footnote{\citet{Wasik_Ramey_etal_1990_CD}.} Our analysis uses the first phase and pools the ABC treatment group with of the CARE treatment groups. We do not use data from the CARE group that only received home visits in the early years. \cite{Campbell_Conti_etal_2014_EarlyChildhoodInvestments} test and do not reject the hypothesis that the CARE data through age 5 (without the home visits) and the ABC data (through age 5) come from the same distribution. \textbf{[JJH: We need to take a position from the same distribution]}.

In ABC, the initial sample consisted of 120 families. For reasons discussed in Appendix~\ref{appendix:background}, the study sample consisted of 111 subjects: 53 in the treatment group and 58 in the control group. In CARE, the initial sample consisted of 65 families, 23 were randomized to a control group, 25 to a family education treatment group, and 17 to a center-based childcare treatment group that followed ABC protocols. Asymptotic and small sample inference agree \citep{Campbell_Conti_etal_2014_EarlyChildhoodInvestments}. We  develop a methodology to assess issues of randomization compromises and item non-response in Appendix~\ref{app:method_partialobs}.

For both programs, from birth until age 8, annual data were collected on cognitive and socio-emotional skills, home environments, family structure, and family economic characteristics. After age 8, data on cognitive and socio-emotional skills, education, and family economic characteristics were collected at ages 12, 15, 21, and 30.\footnote{At age 30, measures of cognitive skills are unavailable for both ABC and CARE.} In addition, we have access to administrative criminal records, a physician-administered medical survey, and a set of medical tests when the subjects were in their mid 30s.\footnote{See  Appendix~\ref{appendix:data} for a more comprehensive description of the data. There, we document the balance in observed baseline characteristics across the treatment and control groups after dropping the individuals for whom we have no crime or health information. There is substantial attrition for these data collections. The methodology that we propose addresses missing data in either of these two outcome categories.}

An important feature of the program is that the control-group children of both ABC and CARE attended alternative (to home and to treatment) childcare arrangements,\footnote{This is an example of the control group finding a treatment substitute in social experiments. See \cite{Heckman_Hohmann_etal_2000_QJE} and \cite{Kline_Walters_2016_QJE} for discussions.} 75\% and 74\% respectively.\footnote{\citet{Burchinal_etal_1989_CD_Daycare-Pre-K-Dev} first document this and provide some analysis on comparisons of treatment to control at alternative arrangements and treatment to home.} The alternative arrangements are, in general, lower quality than ABC/CARE (see  Appendix~\ref{app:control-subbb}).\footnote{Most of the alternative childcare centers received federal subsidies and were subject to the federal regulations of the era (Appendix~\ref{appendix:tetanus}). See \citet{Department-of-Health_1968_DayCareRequirements,NCGA_1971_House-Bill-100,Ramey-et-al_1977_Intro-to-ABC,Ramey_Campbell_1979_SR,Ramey_McGinness_etal_1982_Abecedarianapproach, Burchinal_Campbell_etal_1997_CD}. They had relatively low quality compared to ABC/CARE.}

The control-group children who enrolled in alternative preschools early in their lives remained enrolled. Children were more likely to be enrolled in these alternatives as they aged (see Appendix~\ref{app:control-subbb}). Children enrolled in alternative preschools were more likely to have mothers who worked at baseline.\footnote{The mean difference is statistically significant at 10\%.} Parents of girls were much more likely than parents of boys to use alternative childcare.

Our main results compare treatment- and control-group children, irrespective of take-up of alternatives. In Section~\ref{section:cbaresultscont}, we refine our analysis to comparisons of treatment to alternatives and to staying at home.

\textbf{[JJH: This section needs a lot of work.]}


{ \bf [JLG: I would be happy to go over this in person, but I think this needs to be read carefully in order to understand it. Writing it off as basic or trivial in minutes is not going to be very productive. Also, please note that the referees want us to lead them step by step. It's not always the case that I want to display each little thing. I understand very well the procedure because I wrote it, I proof the theorem behind it that is in the Appendix, and I coded each single step to obtain the estimates. So to me we could just display Figure 2 and claim that everything is trivial. But it doesn't seem to be what Uhlig or the referees think. 

These are the steps. 

1. We construct synthetic cohorts. A basic, initial check for our construction, before doing anything else, is to contrast labor income for our synthetic control group and the non-experimental people for whom $\bf{B} \in \mathcal{B}_0$. 

In addition, at age 30, we can show how these two values compare to the experimental control group. 

This is in Figure 1. 

2. We then determine what are the intermediate inputs. Table 1, which was supposed to be harming us, has been revised. I honestly think that perspective is lost some times regarding the standard errors that could be expected from the samples we have. The table clearly displays strong treatment effects, I have bolded stuff significant at 10\% and it looks just fine. 

3. Then we justify $\phi$ as a means of forecasting. There are TWO aspects to test: 

(i) Within the experiment, is $\phi$ invariant? We test this in Panel (a) of Table 2. We regress income on the inputs and an indicator of treatment. The coefficient on the indicator is very small and not significant. This means that $\phi$ is invariant across treatment regimes. Or to be more precise, we cannot reject invariance in the experiment. 

(ii) Across experimental and non-experimental samples, is $\phi$ invariant? We use the whole experimental and non-experimental samples. Once in the experiment we establish invariance in (i), we can pool treatment and control as the experimental sample and we want to because else we will have power issues. We regress income on the inputs and an indicator of whether the individual belongs to the experiment or not. The coefficient on the indicator is small and not significant. We cannot reject invariance across samples. This is in Panel (b) of Table 2. 

4. We obtain the forecasts and we contrast them with what we observe at age 30 in the treatment and control samples in Figure 2. 

In both Figure 1 and Figure 2 we do VERY WELL in the tests. This takes months if not years of carefully choosing the samples, placing initial restrictions, performing the match, and then doing inference. Of course, once one sees how well the figures work, it could be assessed as being of basic level. But it's not the way it works when put in practice. Particularly for the person that does the work. 

By the way, perhaps this is of interest to no one in the world. But I was quite too amazed about how this all worked and decided to do it with the Perry data just to check if there was something wrong about what I did in ABC/CARE. In Perry, there are two points where one can test the forecast. 27 and 45. The procedure does excellent in both points. But surely no one cares, except for me because I did want to know if this was scientifically rigorous. 

We could place this in the Appendix, but then maybe our referee would say that he's too tired and he doesn't want to see validations. 

5. In addition we can test exogeneity and we do as clearly stated in Section 3.4. We do this in the Appendix because this is beyond what the referees can or want to understand and perhaps they think that factors are magic or they don't trust measurement systems or they think that every time you regress a variable on $\ell$ variables you need $\ell$ experiments. Perhaps that is the culture. In text, we provide him with something lighter that is some basic income processes. That is in Table 3.] }


\section{Forecasting Life-cycle Costs and Benefits: Method} \label{section:cbamethodology}

We describe our forecasting method in formal terms in this section. For specificity, we focus on forecasting labor income. We consider other outcomes in Section~\ref{section:cbapractice}.

Let $W=1$ indicate that the parents referred to the program participate in the randomization protocol. $W=0$ indicates otherwise. $R$ indicates randomization into treatment ($R = 1$) or control ($R = 0$). $D$ indicates attending the program, i.e., $D = R$ implies compliance with the initial randomization protocol. Lower case $d$ and $r$ denote realizations of these random variables.

Individuals are eligible to participate in the program if baseline background variables $\bm{B}\in\mathcal{B}_0$, where $\mathcal{B}_0$ is the set of scores on the risk index that determines program eligibility. Because all of the eligible people with the option to participate choose to do so $(W=1\text{, and } D=R)$, we can safely interpret the treatment effects generated by the experiment as average treatment effects for the population for the eligible population ($\bm{B}\in\mathcal{B}_0$) and not just mean treatment effects for the treated.\footnote{All providers of health care and social services (referral agencies) in the area of the ABC/CARE study were informed of the programs. They referred mothers whom they considered disadvantaged. Eligibility was corroborated before randomization. Our conversations with the program staff indicate that the encouragement from the referral agencies was such that most referred mothers attended and agreed to participate in the initial randomization \citep{Ramey-etal_2012-ABC}.}  Let $\bm{Y}^1_a$ be the outcome vector at age $a$ for the treated. $\bm{Y}^0_a$ is the age-$a$ outcome vector for the controls. At age $a$ the vector of average treatment effects for the population for which $\bm{B}\in\mathcal{B}_0$ is
...
Randomization into treatment identifies this parameter when the corresponding outcomes are observed. A principal contribution of this paper is to provide a methodology for unbiased forecasts when outcomes are not observed in experimental samples. Our methodology is based on a structural model for treatment ($D=1$) and control ($D=0$) outcomes at age $a$ in sample $k \in \{e,n\}$, where $e$ denotes membership in the experimental sample and $n$ denotes membership in a non-experimental (auxiliary) sample. The model is 
\begin{eqnarray}
&Y^d_{k,a} = \phi^d_{k,a} (\bm{X}^d_{k,a}, \bm{B}_k) \ + \ \varepsilon^d_{k,a},  \label{eq:outcome} \\
 &d \in\{0,1\},  k\in\{e,n\}, \ \ a\in\{1,\dots,\bar{A}\} \nonumber
\end{eqnarray}

\noindent where $\phi^d_{k,a}\left( \cdot, \cdot \right)$ is a structural production relationship mapping inputs $\bm{X}^d_{k,a}, \bm{B}_k$ into output $Y^d_{k,a}$ holding error term $\varepsilon^d_{k,a}$ fixed.\footnote{Fixing and conditioning are fundamentally different concepts. See \cite{Haavelmo_1943_Econometrica} and \citet{Heckman_Pinto_2015_EconometTheory} for discussions.} $ \bm{B}_k$ are baseline variables not affected by treatment. $\bm{X}^d_{k,a}$ are variables potentially affected by treatment (intermediate inputs). $\bar{A}$ is the oldest age in the non-experimental sample. 

The relationship between $\bm{X}^d_{k,a}, \bm{B}_k$ and $Y^d_{k,a}$ can differ between experimental and non-experimental samples. The model characterizes the two treatment regimes in the non-experimental sample, although there are no empirical counterparts for those counterfactuals. The exercise consists of providing conditions for identifying and estimating $\phi^d_{k,a}\left( \cdot, \cdot \right)$ in the non-experimental sample and using it to forward forecast the experimental sample. Some of the conditions required can be tested using the available experimental sample. Our procedure consists of the following steps for all outcomes (including labor earnings): 

\begin{enumerate}
\item \textbf{Construct a Synthetic Cohort.} Select an eligible non-experimental sample ($\bm{B}_k \in \bm{B}_0$).
...
\item \textbf{Identify and Estimate $\phi^d_{k,a}\left( \cdot, \cdot \right)$ in the Non-experimental Sample.} Characterize and test conditions under which $\phi^d_{k,a}\left( \cdot, \cdot \right)$ is identified in the non-experimental sample. Estimate these functions in that sample. Construct structural forecast in the post-treatment non-experimental sample. Compare forecasts with actual observations in the experimental data at experimental sample ages. 
\item \textbf{Make Valid Inference.} Construct standard errors that account for estimation and forecasting error and sampling uncertainty in the experimental and the non-experimental datasets.
\end{enumerate}

For specification, consider the forecast of life-cycle labor income. In the non-experimental sample, we observe labor income from ages 21 to 67 (assumed to be age of retirement). We use these data to estimate a labor income function which depends on intermediate inputs (achievement test scores, education, and lagged labor income). These variables are affected by treatment in the experimental data. Invariance of the labor income function across treatment regimes and across the experimental and non-experimental samples makes it a valid tool for forecasting post-experimental outcomes. In the experimental data, we observe labor income at ages 21 and 30. We evaluate the production function for labor income at age 22 in the experimental data and obtain a forecast. We apply this procedure through age 67. At age 30, we observe actual labor income, and can compare it with the forecast income. Forecasted and observed level of labor income at age 30 should be closely aligned under our invariance assumptions. We test and do not reject this assumption. We provide details on this procedure for the case of labor income next.\footnote{Appendix~\ref{appendix:incomplete} provides more detail.}



\subsection{Constructing a Synthetic Cohort} \label{section:synthetic}

We use the Children of the National Longitudinal Survey of Youth (CNLSY) to construct synthetic cohorts from ages 21 to 29. We use both the National Longitudinal Survey of Youth 1979 (NLSY79) and the Panel Study of Income Dynamics (PSID) to forecast from ages 29 to 67. Whenever we use the NLSY79 and PSID together, we combine them and use them as a joint sample. Put differently, we use the three data sets to obtain information across our time span of interest, without placing specific weights in any particular sample. We satisfy support conditions (see Appendix~\ref{app:containsupport}).

To approximate $\bm{B}_{n} \in \mathcal{B}_0$, we place initial restrictions and include observations satisfying the following criteria:
...
Given these restrictions, we construct synthetic control and treatment groups by applying Mahalanobis' matching Algorithm~\ref{alg:match} in Appendix~\ref{appendix:methodology}. This algorithm provides a weight for each individual in the non-experimental sample according to her resemblance with the individuals in the experimental sample. When constructing synthetic control and treatment groups, we use each of the following variables at all ages: year of birth, gender, and number of siblings at baseline. \textbf{[JJH: Why aren't these above?] [JLG: Basic initial restrictions are placed as written in 1., 2., and 3. above. By basic I mean, drop labor income outliers, people who are too young or too old, or people who are not of the same race as the people in our sample. Then, a matching procedure is performed based on year of birth, gender, and number of siblings. We do not place initial restrictions based on the latter three variables because then we have issues with satisfying common support.]} The criterion for selecting these variables is availability across all non-experimental datasets. We construct one synthetic control group and one synthetic treatment group in each non-experimental sample (not one group for each age). In the experimental sample, all of the parents of children with characteristics $\bm{B}_{e} \in \mathcal{B}_0$ agree to participate in the program and satisfy these criteria.

We can evaluate the validity of the synthetic control group by comparing average labor income of individuals in the non-experimental sample for whom $\bm{B}_{n} \in \mathcal{B}_0$ to average labor incomes of individuals in our synthetic control groups constructed from the model. They should coincide at each age. Further, they should coincide with observed control group labor income at age 30 in the experimental sample. Figure~\ref{figure:controltests} displays these tests. \textbf{[JJH: This test? It's two tests!] [JLG: In fact. I have modified the text to ``these tests.'']} The agreement is reassuringly close. Note that these comparisons do not involve estimation of  $\phi^d_{k,a}\left( \cdot, \cdot \right)$.
...
\end{tablenotes}
\end{threeparttable}
\textbf{[JJH: This table is harmful. We should drop this. None of these are statistically significant. What is $R^2$ for this equation F test for set?] [JLG: I am sure that the confusion here had to do with the units. Please see the table again. For PIAT, the treatment effects are there for males and females. The standard deviation of the variable is 15. For years of education, for females this is generates by high school graduation and for males by college graduation. I dropped a bizarre observation for years of observation for males and now it looks better. For labor income, we always knew that the effects was weak for females and that we needed the whole life cycle. I dropped labor income at age 21. That's just noise. Many individuals do not supply labor to begin with at age 21.] [JLG: I am not sure what $R^2$ or $F$ tests you want to see. These are simply treatment effects on each of the outcomes by gender. Less is more here. Displaying more stats is going to confuse more our already mentally convoluted referee.] [JLG: I do not agree that this table should be dropped. It's a request of a referee and it's informative on why we use the inputs that we use.]}
\end{table}

Random assignment to treatment has statistically and economically significant effects on the intermediate inputs. For females, it increases the average PIAT score by almost a third of standard deviation (the test is standardized to an in-sample standard deviation of 15 units). For males, the effect is almost half of a standard deviation. The program substantially boosts high-school graduation for females and college graduation for both males and females. As a joint summary of these effects, we use years of education as an intermediate input. Labor income at age 21 is not greatly boosted by the program. This happens because treatment-group individuals are more likely to be enrolled in college at age 21 and thus not supply labor at this age. \textbf{[JJH: What does this mean? Labor supply is part of income.] [JLG: Please see text before. This is obvious. The treatment-group individuals do not supply labor because they are studying and thus the treatment effect on labor income at age 21 is weak.]} However, as the life-cycle evolves, lagged labor income is important for obtaining precise forecasts, as economic theory suggests. As the life cycle evolves, the program boosts annual labor income, especially for males, for whom the average treatment effect at age 30 is almost 20 thousand dollars.\footnote{Table~\ref{table:summint} displays age-21 and age-30 labor income because labor income is observed at ages 21 and 30 in the experimental sample. Labor income at age 30 is an input in our methodology only after age 30.}

\subsection{Identifying and Estimating $\phi^d_{k,a}\left( \cdot, \cdot \right)$ in the Non-experimental Sample}

For identifying and estimating life-cycle treatment effects, forecasting the treatment-control mean difference suffices \textbf{[JJH: For what purpose?] [JLG: This has been clarified now.]}. This does not require us to take a position on the exogeneity of $\bm{X}^d_k, \: k \in \{e,n\}$ with respect to labor income. Simpler conditions, spelled out as Conditions~\ref{cond:cond1} and~\ref{cond:cond2} in Appendix~\ref{appendix:incomplete}, suffice. Exogeneity facilitates the use of economic theory to generate and interpret treatment effects, to test the validity of our synthetic control groups, and to find auxiliary sample counterparts to treatments and controls. It also facilitates a non-parametric approach that we discuss in Section~\ref{section:following}. Exogeneity also makes identification of $\phi^d_{k,a}\left( \cdot, \cdot \right)$ in the non-experimental sample straightforward. Assumption~\ref{ass:exog} spells out this assumption, which we initially make and then explore alternatives. \textbf{[JJH: We don't need this!] [JLG: Sure we don't and we said that in this very paragraph, but it gives us intuitive testable implications in levels as you wrote in the introduction.]}
...
Assumption~\ref{ass:summary} has two distinct aspects which could be broken down into two separate assumptions: (i) the structural relationships evaluated at the same arguments have identical values for treatment and control groups in the experimental sample, and (ii) the analogous holds across the experimental and non-experimental samples. \textbf{[JJH: What? We can't test (4) in non-experimental sample.] [JLG: I'm not sure where this notion got lost from our many previous discussions. In Equation (4) there are two aspects: (i) invariance within the experiment. This is tested in Panel (a) of Table 2. Then we test invariance across the samples---experiment (pooling treatment and control) and non-experiment (pooling the two synthetic cohorts). This is Panel (b) of Table 2. This is precisely why in equation (4) the first equality ``looses" the superindex and then the second equality ``looses'' the subindex $k$. These tests were presented in the draft that we submitted. The referee doesn't understand magnitudes and complains about the Appendix length so I brought those tests into the text.}
\end{remark}

\begin{remark} \label{remark:cohort} \textbf{(No) Cohort Effects}
The second aspect of Assumption~\ref{ass:summary}, that the structural relationships are identical in the experimental and non-experimental samples, embeds a no cohorts effects assumption. That is: A structural function $\phi_{n,a}^d \left( \bm{x}, \bm{b} \right)$, which we identify and estimate in the non-experimental sample with subjects that are older than those in the experimental sample, is a valid means for forecast in the experimental sample. Note that this does not mean that there are not cohort effects in the outcome of interest, $Y_{k,a}^d$. Instead, it means that there are no cohort effects in the mapping between $\bm{X}_{k,a}, \bm{B}_k$ and $Y_{k,a}^d$. \textbf{[JJH: How are these two notions different?] [JLG: One would be that the mapping displays no cohort effects, while the other would be that the levels do not display cohort effects. No cohort effects in the mapping is actually one interpretation of invariance across experimental and non-experimental samples.]}
\end{remark}
\doublespacing
...
\item Note for Panel (b): Results from regressing, in the pooled experimental and non-experimental  samples, labor income at age 30 on the variables listed in the left-most column by gender. \textbf{[JJH: 1 year is \$8000? F tests?] [JLG: Yes. One year of education increases, on average, annual labor income at age 30 by $8,091.138$ dollars --- of course under mean independence, but this is surely biased and thus the high value. $F$-tests in display.]}
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\textbf{[JJH: Section 3 needs a lot of work.]}
