...
At age 30, we observe labor income in the experimental sample for both the treatment and the control groups. If Condition~\eqref{eq:suff1} holds, the coefficient associated with $R$ (randomization to treatment  in ABC/CARE, which, as discussed, is equivalent to $D$), denoted by $\Delta$, with $R$ being zero when estimating the following baseline linear technology: 
