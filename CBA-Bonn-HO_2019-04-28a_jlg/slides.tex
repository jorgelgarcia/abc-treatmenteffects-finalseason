...
\def \thetitle {\large Quantifying the Multifaceted and Gender-Specific \\ Life-cycle Benefits \\ of an Influential Early Childhood Program} % Full title goes here

\def \theshorttitle {Quantifying the Life-cycle Benefits of an Early Childhood Program} %Short title goes here

\def \theauthor {\scriptsize Jorge Luis García \\ John E. Walker Department of Economics \\ Clemson University \\ and \\ James J. Heckman\\ University of Chicago\\ and \\ Duncan Ermini Leaf, Mar\'{i}a Jos\'{e} Prados\\ University of Southern California} % Author name(s) go here

\def \theshortauthor {Garc\'{i}a et al.} % Short author name(s) go here; should fit on this one line.

\def \thedate {\scriptsize briq \\ Institute on Behavior \& Inequality \\ Short Lecture Series \\ May 6, 2019} % Date and venue information

\def \eventnotes {\noindent
\textbf{Date:} Tuesday, November 21st, 2017\\
\textbf{Event Title:} Bar Ilan University Talk \\
\textbf{Host:} Bar Ilan University \\
\textbf{Location:} Bar Ilan University, Nanotechnology Building (206) Hall C-50 \\
\textbf{Presentation Title:} Understanding the Multi-Faceted Life-Cycle Benefits of an Influential Early Childhood Program \\
\textbf{Format:} 75 minute lecture and 15 minute Q\&A \\
\textbf{Length:} 90 minutes \\
\textbf{Time:}  4:00 p.m. \\
\textbf{Audience Background:} University's faculty and graduate students. \\
...
\begin{center}
\includegraphics[width=\textwidth]{images/Elephant-A_2017-05-26a_jbb}\\
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{images/Elephant-B_2017-05-29a_jbb}\\
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{images/Elephant-B_2017-05-26a_jbb}\\
\end{center}
...
%% ------------------------------------------------------------------------------------------------
\begin{frame}
 \addtocounter{framenumber}{-1} %%CONTINUED #2
...
\begin{tabular}{L{2cm} *{21}{c}}
\toprule
\multicolumn{4}{c}{ \textbf{Specification 5:}} & & \multicolumn{3}{c}{\textbf{Baseline Estimates}} \\
\multicolumn{4}{c}{Non-parametric (under exogeneity)} & & & & \\
\bottomrule \\[5pt]
& NPV & IRR & B/C & & NPV & IRR & B/C \\
\hline \\
...
\begin{center}
\hyperlink{ret:cereal}{\underline{Return to main text}}
\end{center}
...
\begin{table}[H]
\caption{Treatment Effects on Selected Outcomes, Males, Cont'd}\label{table:tescombinedmales}
\begin{center}
\mode<presentation>{\begin{tiny}}
\mode<article>{\begin{Large}}
\resizebox{\textwidth}{!}{
...
\midrule
  \mc{1}{l}{\scriptsize{Crime}} &    \mc{1}{l}{\scriptsize{Total Felony Arrests}} & \mc{1}{c}{\scriptsize{Mid-30s}} & \mc{1}{c}{\scriptsize{1.370}} & \mc{1}{c}{\scriptsize{0.196}} & \mc{1}{c}{\scriptsize{0.685}} & \mc{1}{c}{\scriptsize{1.523}} & \mc{1}{c}{\scriptsize{1.340}} & \mc{1}{c}{\scriptsize{0.481}} & \mc{1}{c}{\scriptsize{0.188}} \\
   &  &  & & \mc{1}{c}{\scriptsize{(0.368)}} & \mc{1}{c}{\scriptsize{(0.183)}} & \mc{1}{c}{\scriptsize{\textbf{(0.064)}}} & \mc{1}{c}{\scriptsize{\textbf{(0.026)}}} & \mc{1}{c}{\scriptsize{(0.284)}} & \mc{1}{c}{\scriptsize{(0.410)}} \\
          &  &  & &  \mc{1}{c}{\scriptsize{[0.396]}} & \mc{1}{c}{\scriptsize{[0.429]}}  & \mc{1}{c}{\scriptsize{[0.120]}} & \mc{1}{c}{\scriptsize{\textbf{[0.081]}}}  & \mc{1}{c}{\scriptsize{[0.562]}} & \mc{1}{c}{\scriptsize{[0.434]}} \\
  ...
  &   &  & & \mc{1}{c}{\scriptsize{(0.171)}} & \mc{1}{c}{\scriptsize{(0.289)}} & \mc{1}{c}{\scriptsize{(0.314)}} & \mc{1}{c}{\scriptsize{(0.422)}} & \mc{1}{c}{\scriptsize{(0.329)}} & \mc{1}{c}{\scriptsize{(0.168)}} \\
          &  &  & &  \mc{1}{c}{\scriptsize{[0.395]}} & \mc{1}{c}{\scriptsize{[0.429]}}  & \mc{1}{c}{\scriptsize{[0.314]}} & \mc{1}{c}{\scriptsize{[0.422]}}  & \mc{1}{c}{\scriptsize{[0.562]}} & \mc{1}{c}{\scriptsize{[0.411]}} \\
...
\begin{table}[H]
\caption{Treatment Effects on Selected Outcomes, Females$^*$, Cont'd}\label{table:tescombinedfemales}
\begin{center}
\mode<presentation>{\begin{tiny}}
\mode<article>{\begin{Large}}
\resizebox{\textwidth}{!}{
\begin{tabular}{cccccccccccc}
 ...
 &    &  & & \mc{1}{c}{\scriptsize{\textbf{(0.077)}}} & \mc{1}{c}{\scriptsize{\textbf{(0.087)}}} & \mc{1}{c}{\scriptsize{\textbf{(0.095)}}} & \mc{1}{c}{\scriptsize{\textbf{(0.095)}}} & \mc{1}{c}{\scriptsize{(0.287)}} & \mc{1}{c}{\scriptsize{(0.500)}} \\
       &   &  & & \mc{1}{c}{\scriptsize{[0.134]}} & \mc{1}{c}{\scriptsize{[0.215]}}  & \mc{1}{c}{\scriptsize{[0.167]}} & \mc{1}{c}{\scriptsize{[0.186]}} & \mc{1}{c}{\scriptsize{[0.432]}} & \mc{1}{c}{\scriptsize{[0.610]}} \\
 ...
 &    &  & & \mc{1}{c}{\scriptsize{\textbf{(0.057)}}} & \mc{1}{c}{\scriptsize{(0.134)}} & \mc{1}{c}{\scriptsize{(0.134)}} & \mc{1}{c}{\scriptsize{(0.120)}} & \mc{1}{c}{\scriptsize{(0.273)}} & \mc{1}{c}{\scriptsize{(0.289)}} \\
      &   &  & & \mc{1}{c}{\scriptsize{[0.134]}} & \mc{1}{c}{\scriptsize{[0.238]}}  & \mc{1}{c}{\scriptsize{[0.167]}} & \mc{1}{c}{\scriptsize{[0.186]}} & \mc{1}{c}{\scriptsize{[0.432]}} & \mc{1}{c}{\scriptsize{[0.610]}} \\
...
& \multicolumn{3}{c}{Non-parametric matching} \\
\bottomrule \\[5pt]
& NPV & IRR & B/C\\
\hline \\
...
\textbf{[JJH: Do we have sensitivity for non-market?] [JLG: The argument that we made in the paper was the following. Suppose that for each dollar of labor income that the program caused, it also caused a dollar decrease in leisure. If we give an hour of leisure the same value as an hour of work, the labor income gain from the program would be eliminated. For that case, the B/C ratio diminished to 4.86 (s.e. 2.18) for the pooled sample. We have the same exercise for parental income in Table 9. [JJH: 10? I am asking about sensitivity (a) we have estimation error, (b) when we consider crime ranges we lack standard errors -- so we display ranges of estimates under ``measurable'' assumptions and add std errors from economical estimated component.] This is an extreme example, but we can produce some other estimates if you would like.] [JJH: I am just asking if we have this lying around.] [JLG: Yes. Sorry for the misunderstanding here. For crime, the following is the sensitivity analysis that we have done. In Table 11, we present two movements away from the baseline which could appear reasonable:
\begin{enumerate}
\item Remove major crimes (rapes and murders). This could be reasonable if we think that those events were completely random and our samples are ot big enough to average them out. But more related to your point,
\item One dispute in the literature is judiciary and administrative costs, because they are often believed to be too high. In Table 11, we present an estimates that halves the crime costs. This is approximately equivalent to getting rid of administrative and judiciary costs.
\end{enumerate}
In either (1) and (2), we still account for the the rest of the estimation error and sampling variation as we do in the rest of the paper. More generally, every single case of sensitivity that we present in the paper is a variation of the baseline estimates only in one direction (e.g. removing one component, accounting for IPW, etc.) but the rest is calculated as in the baseline (accounting for model selection, prediction error, etc). That is why when we estimate the full sensitivity analyses cases we take long. Because we re-estimate the full prediction model for each case.]}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{include/factors1}
\end{center}
\end{table}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{include/factors2}
\end{center}
\end{table}
{\flushleft \tiny This table presents treatment effects on latent factor scores constructed using all measures of parental income, employment and labor income, crime, and health (hypertension- and cholesterol-related measures). The in-sample mean of the latent factor scores is zero and the standard deviation is 1. Starred point estimates are statistically significant at the 10\% level.\\}
