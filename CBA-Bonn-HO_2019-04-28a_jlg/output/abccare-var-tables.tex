...
\section{Variable Measures (10 bootstraps)}
  ...
  \subsection{Variables in Paper (200 bootstraps)}
    \subsubsection{IQ}
    \input{abccare-outcome-var-iq}

    \subsubsection{Achievement}
    \input{abccare-outcome-var-ach}

    \subsubsection{Parenting}
    \input{abccare-outcome-var-parenting}

    \subsubsection{Social-emotional}
    \input{abccare-outcome-var-se}

    \subsubsection{Education}
    \input{abccare-outcome-var-ed}

    \subsubsection{Employment}
    \input{abccare-outcome-var-emp}

    \subsubsection{Parental income}
    \input{abccare-outcome-var-parent}

    \subsubsection{Health}
    \input{abccare-outcome-var-health}

    \subsubsection{Crime}
    \input{abccare-outcome-var-crime}
