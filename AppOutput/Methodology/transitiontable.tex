...
BMI & $\times$& $\times$&$\times$ & $\times$& $\times$& $\times$&$\times$ &$\times$ & $\times$    &  $\times$ &     & $\times$ & $\times$   & $\times$\\
Physical Activ. & $\times$& $\times$&$\times$ & $\times$& $\times$& $\times$&$\times$ &$\times$ & $\times$    &   &     & $\times$ & $\times$   & $\times$\\
Binge Drinking & & & & & & &  &$\times$ & $\times$    &      &      & $\times$ & $\times$   & $\times$\\
\midrule
