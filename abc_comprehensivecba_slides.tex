...
\frametitle{Preview of Results: Cost-benefit Analysis}
	...
	\end{itemize}
	\centering
	\scalebox{.85}{\input{output/cba_results_summary}}
\end{frame}
...
\begin{table}
	...
	\scalebox{0.7}{\input{output/rslt_female_main1}}
\end{table}
\begin{tiny}
...
\end{tiny}
\hyperlink{stepdownfemales}{\beamergotobutton{Stepdown}} \hyperlink{royfemales}{\beamergotobutton{Roy}}
\end{frame}
...
\begin{table}
	...
	\scalebox{0.7}{\input{output/rslt_male_main1}}
\end{table}
\begin{tiny}
\leftright{\textbf{(1)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) | D = 1\big]$}{\textbf{(4)} $\mathbb{E}_\Omega \big[ Y^1(v, \omega) - Y^0(v, \omega) | V=0, D = 1 \big] $} \par
\leftright{\textbf{(2)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) |  X, D = 1 \big]$}{\textbf{(5)} $\mathbb{E}_\Omega \big[ Y^1(\omega) \big] - \mathbb{E}_\Omega \big[ Y^0(v, \omega) | V > 0, D =1 \big]$} \par
...
\hyperlink{roymales}{\beamergotobutton{Roy}}
\end{frame}
...
\begin{table}
	\caption{ABC and CARE Females, Selected Outcomes}
	\scalebox{0.8}{\input{output/selected_rslt_female_sd.tex}}
\end{table}
\begin{tiny}
\leftright{\textbf{(1)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) | D = 1\big]$}{\textbf{(4)} $\mathbb{E}_\Omega \big[ Y^1(v, \omega) - Y^0(v, \omega) | V=0, D = 1 \big] $} \par
\leftright{\textbf{(2)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) |  X, D = 1 \big]$}{\textbf{(5)} $\mathbb{E}_\Omega \big[ Y^1(\omega) \big] - \mathbb{E}_\Omega \big[ Y^0(v, \omega) | V > 0, D =1 \big]$} \par
...
\begin{table}
	\caption{ABC and CARE Males, Selected Outcomes}
	\scalebox{0.7}{\input{output/selected_rslt_male_sd.tex}}
\end{table}
\begin{tiny}
\leftright{\textbf{(1)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) | D = 1\big]$}{\textbf{(4)} $\mathbb{E}_\Omega \big[ Y^1(v, \omega) - Y^0(v, \omega) | V=0, D = 1 \big] $} \par
\leftright{\textbf{(2)} $\mathbb{E}_\Omega \big[ Y^1(\omega) - Y^0(\omega) |  X, D = 1 \big]$}{\textbf{(5)} $\mathbb{E}_\Omega \big[ Y^1(\omega) \big] - \mathbb{E}_\Omega \big[ Y^0(v, \omega) | V > 0, D =1 \big]$} \par
...
\begin{table}
	...
	\scalebox{0.75}{\input{output/selected_rslt_female_cf.tex}}
\end{table}
\begin{tiny}
...
\begin{table}
	...
	\scalebox{0.65}{\input{output/selected_rslt_male_cf.tex}}
\end{table}
\begin{tiny}
\textbf{(1)} $\mathbb{E}_{\Omega} \left[ Y^1 \left( \omega \right) | D = 1 \right] - \mathbb{E}_{\Omega} \left[ Y^0_H \left( \omega, v \right) | V = 0 , D = 1  \right]$\\ 
\textbf{(2)} $\mathbb{E}_{\Omega} \left[ Y^1 \left( \omega \right) | , D = 1 \right] - \mathbb{E}_{\Omega} \left[ Y^0_C \left( \omega, v \right) | V = 1 , D = 1  \right]$\\
